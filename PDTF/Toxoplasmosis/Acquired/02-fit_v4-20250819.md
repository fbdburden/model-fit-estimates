Global incidence of acquired toxoplasmosis • Fit model • Version 4
================
fbbu6966
2025-08-19
...
![](02-fit_v4-20250819_files/figure-gfm/unnamed-chunk-1-1.png)<!-- -->![](02-fit_v4-20250819_files/figure-gfm/unnamed-chunk-1-2.png)<!-- -->![](02-fit_v4-20250819_files/figure-gfm/unnamed-chunk-1-3.png)<!-- -->
...
![](02-fit_v4-20250819_files/figure-gfm/unnamed-chunk-1-4.png)<!-- -->![](02-fit_v4-20250819_files/figure-gfm/unnamed-chunk-1-5.png)<!-- -->![](02-fit_v4-20250819_files/figure-gfm/unnamed-chunk-1-6.png)<!-- -->![](02-fit_v4-20250819_files/figure-gfm/unnamed-chunk-1-7.png)<!-- -->

    ## Warning in RColorBrewer::brewer.pal(max_freq, "Greens"): minimal value for n is 3, returning requested palette with 3 different levels

![](02-fit_v4-20250819_files/figure-gfm/unnamed-chunk-1-8.png)<!-- -->
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpEZN3i4/file341c5eed34f9 -V' had status 1

``` r
setwd("./Acquired/ESTIMATES")
es <- es$Acquired_incidence
es$FLAG <-
  factor(es$FLAG, 
...
``` r
## remove STUDY_ID/DTP_ID - only one estimate per country
...
```
    ...
    ##    Data: subset(es, as.integer(FLAG) == 1) (Number of observations: 79) 
    ...
    ## sd(Intercept)     0.41      0.26     0.04     1.03 1.00     2970     4655
    ## 
    ## ~REG2:SUB2 (Number of levels: 17) 
    ##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(Intercept)     0.20      0.15     0.01     0.55 1.00     1585     3368
    ## 
    ## ~REG2:SUB2:COUNTRY (Number of levels: 79) 
    ##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(Intercept)     0.73      0.07     0.61     0.88 1.00     3431     5408
    ## 
    ## Regression Coefficients:
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept     6.49      0.23     5.99     6.93 1.00     5974     5216
    ## 
...
![](02-fit_v4-20250819_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->
...
```
    ...
    ##   r_2_1 = (sd_2[1] * (z_2[1]));
    ##   r_3_1 = (sd_3[1] * (z_3[1]));
    ##   lprior += student_t_lpdf(Intercept | 3, 6.7, 2.5);
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpEZN3i4/file341c13fac35 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpEZN3i4/file341c13fac35". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ──────────────────────────────────────────────────────────────────────────────────────────────────────────────
