Cadmium CKD5 Age 75-84 • Models fit
================
LoVa3397
2025-10-16
...
```
    ...
    ## Warning in add_pop(dta[[h]]): Warning: 648 rows have missing data for the population variable. Please check if ISO3 code is correctly specified and if
    ## the dates are included in the study field.
    ...
    ## Warning: Expecting logical in AR1260 / R1260C44: got 'Rule(10): GFR-R = 224 Scr -1.190 age -0.236( 0.796 in female) ( 1.26 in healthy)'
    ...
    ## Warning: Expecting logical in AR1294 / R1294C44: got 'formula：GFR＝Dln（P1 ／P2 ）／（T2 － T1）exp ［（T1lnP2）－（T2lnP1）］／（T2 －T1）'

    ## Warning: Expecting logical in AR1296 / R1296C44: got 'There is no specific number of people in the groups'

    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/LoVa3397/AppData/Local/Temp/RtmpCaN2ur/file23a855487b10 -V' had status 1
...
![](M:/11401_LifeChron_FERG_DWH/Estimates/cttf-metals/cadmium/ESTIMATES/02-fit/CKD5_80/02-fit-CKD_v2_files/figure-gfm/r_conditional_effects-1.png)<!-- -->
...
(z_5\[1\])); lprior += student_t_lpdf(Intercept \| 3, -14.7, 6.3);
...
+= Intercept + Xc \* b; for (n in 1:N) { // add more terms to the linear
predictor mu\[n\] += r_1_1\[J_1\[n\]\] \* Z_1_1\[n\] + r_2_1\[J_2\[n\]\]
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/LoVa3397/AppData/Local/Temp/RtmpCaN2ur/file23a823c8773d -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/LoVa3397/AppData/Local/Temp/RtmpCaN2ur/file23a823c8773d". Did you mean command "install"? @ C:\\PROGRA~1\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ────────────────────────────────────────────────────────────────────────────────────────────────────────────
