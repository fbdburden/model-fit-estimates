Cadmium CKD5 Age 85-125 • Models fit
================
LoVa3397
2025-10-16
...
```
    ...
    ## TMPDIR=C:/Users/LoVa3397/AppData/Local/Temp/RtmpsVe1vM/file3e6c1fdf4e40 -V' had status 1
...
![](M:/11401_LifeChron_FERG_DWH/Estimates/cttf-metals/cadmium/ESTIMATES/02-fit/CKD5_90/02-fit-CKD_v2_files/figure-gfm/r_conditional_effects-1.png)<!-- -->
...
(z_5\[1\])); lprior += student_t_lpdf(Intercept \| 3, -12.4, 6); lprior
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/LoVa3397/AppData/Local/Temp/RtmpsVe1vM/file3e6c27f6303b -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/LoVa3397/AppData/Local/Temp/RtmpsVe1vM/file3e6c27f6303b". Did you mean command "preview"? @ C:\\PROGRA~1\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ────────────────────────────────────────────────────────────────────────────────────────────────────────────
