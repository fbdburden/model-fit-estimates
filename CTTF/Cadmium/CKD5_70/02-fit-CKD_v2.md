Cadmium CKD5 Age 65-74 • Models fit
================
fbbu6966
2025-10-16
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpmweLx4/file2af810b344b1 -V' had status 1
...
![](\sciensano.be/fs/11401_LifeChron_FERG_DWH/Estimates/cttf-metals/cadmium/ESTIMATES/02-fit/CKD5_70/02-fit-CKD_v2_files/figure-gfm/r_conditional_effects-1.png)<!-- -->
...
(z_5\[1\])); lprior += student_t_lpdf(Intercept \| 3, -15, 6.6); lprior
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpmweLx4/file2af87490751d -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpmweLx4/file2af87490751d". Did you mean command "update"? @ C:\\PROGRA~1\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ────────────────────────────────────────────────────────────────────────────────────────────────────────────
