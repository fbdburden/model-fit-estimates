Cadmium CKD4 Age 55-64 • Models fit
================
fbbu6966
2025-10-16
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmpa6w3JV/file347c4d7b702d -V' had status 1
...
![](\sciensano.be/fs/11401_LifeChron_FERG_DWH/Estimates/cttf-metals/cadmium/ESTIMATES/02-fit/CKD4_60/02-fit-CKD_v2_files/figure-gfm/r_conditional_effects-1.png)<!-- -->
...
// generated with brms 2.23.0 functions { } data { int\<lower=1\> N; //
...
effects vector\[N_5\] r_5_1; // actual group-level effects // prior
contributions to the log posterior real lprior = 0; r_1_1 = (sd_1\[1\]
\* (z_1\[1\])); r_2_1 = (sd_2\[1\] \* (z_2\[1\])); r_3_1 = (sd_3\[1\] \*
(z_3\[1\])); r_4_1 = (sd_4\[1\] \* (z_4\[1\])); r_5_1 = (sd_5\[1\] \*
(z_5\[1\])); lprior += student_t_lpdf(Intercept \| 3, -15, 6.7); lprior
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmpa6w3JV/file347c43b45edf -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmpa6w3JV/file347c43b45edf". Did you mean command "update"? @ C:\\PROGRA~1\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ────────────────────────────────────────────────────────────────────────────────────────────────────────────
