Cadmium CKD4 Age 45-54 • Models fit
================
fbbu6966
2025-10-16
...
```
    ...
    ## Warning in add_pop(dta[[h]]): Warning: 648 rows have missing data for the population variable. Please check if ISO3 code is correctly
    ...
    ## Warning: Expecting logical in AR1294 / R1294C44: got 'formula：GFR＝Dln（P1 ／P2 ）／（T2 － T1）exp ［（T1lnP2）－（T2lnP1）］／（T2
    ## －T1）'

    ## Warning: Expecting logical in AR1296 / R1296C44: got 'There is no specific number of people in the groups'

    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpqmYr20/file579836b6ab1 -V' had status 1
...
![](\sciensano.be/fs/11401_LifeChron_FERG_DWH/Estimates/cttf-metals/cadmium/ESTIMATES/02-fit/CKD4_50/02-fit-CKD_v2_files/figure-gfm/r_conditional_effects-1.png)<!-- -->
...
(z_5\[1\])); lprior += student_t_lpdf(Intercept \| 3, -15, 6.9); lprior
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpqmYr20/file57985ee46da5 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpqmYr20/file57985ee46da5". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
