Cadmium CKD4 Age 65-74 • Models fit
================
LoVa3397
2025-10-16
...
```
    ...
    ## TMPDIR=C:/Users/LoVa3397/AppData/Local/Temp/RtmpkvrYt3/file2ae43f1a32f1 -V' had status 1
...
![](M:/11401_LifeChron_FERG_DWH/Estimates/cttf-metals/cadmium/ESTIMATES/02-fit/CKD4_70/02-fit-CKD_v2_files/figure-gfm/r_conditional_effects-1.png)<!-- -->
...
(z_5\[1\])); lprior += student_t_lpdf(Intercept \| 3, -13.6, 5.9);
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/LoVa3397/AppData/Local/Temp/RtmpkvrYt3/file2ae472fb69e0 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/LoVa3397/AppData/Local/Temp/RtmpkvrYt3/file2ae472fb69e0". Did you mean command "preview"? @ C:\\PROGRA~1\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ────────────────────────────────────────────────────────────────────────────────────────────────────────────
