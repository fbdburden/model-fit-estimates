...
```
    ...
    ## Warning in if_else(!is.na(dta$REF_YEAR_END), dta$REF_YEAR_END, as.numeric(dta$SOURCE_YEAR) - :
    ## NAs introduced by coercion

    ## Warning in add_LB(dta): Warning: 71 rows have missing data for the population variable. Please
    ...
    ## '"quarto" TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmps5e25F/file35f010065c91 -V' had
    ## status 1
...
```
    ...
    ## Warning: There were 26 divergent transitions after warmup. Increasing adapt_delta above 0.95
...
(z_5\[1\])); lprior += student_t_lpdf(Intercept \| 3, 0.8, 3.4); lprior
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command
    ## '"quarto" TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmps5e25F/file35f0154754c2 -V' had
    ## status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmps5e25F/file35f0154754c2". Did you mean command "update"? @ C:\\PROGRA~1\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────────
