Methylmercury Moderate • Models fit
================
LoVa3397
2025-09-16
...
```
    ...
    ## Warning in if_else(!is.na(dta$REF_YEAR_END), dta$REF_YEAR_END,
    ## as.numeric(dta$SOURCE_YEAR) - : NAs introduced by coercion

    ## Warning in add_LB(dta): Warning: 71 rows have missing data for the population
    ## variable. Please check if ISO3 code is correctly specified and if the dates are
    ...
    ## TMPDIR=C:/Users/LoVa3397/AppData/Local/Temp/RtmpCGcPbm/file266c3f544ad -V' had
    ## status 1
...
(z_5\[1\])); lprior += student_t_lpdf(Intercept \| 3, -2.7, 3.4); lprior
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", :
    ## running command '"quarto"
    ## TMPDIR=C:/Users/LoVa3397/AppData/Local/Temp/RtmpCGcPbm/file266c10625c09 -V' had
    ## status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/LoVa3397/AppData/Local/Temp/RtmpCGcPbm/file266c10625c09". Did you mean command "install"? @ C:\\PROGRA~1\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────
