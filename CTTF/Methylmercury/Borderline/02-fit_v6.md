Methylmercury Borderline • Models fit
================
LoVa3397
2025-09-17
...
```
    ...
    ## Warning in if_else(!is.na(dta$REF_YEAR_END), dta$REF_YEAR_END, as.numeric(dta$SOURCE_YEAR) - : NAs introduced by
    ## coercion

    ## Warning in add_LB(dta): Warning: 71 rows have missing data for the population variable. Please check if ISO3 code
    ...
    ## TMPDIR=C:/Users/LoVa3397/AppData/Local/Temp/Rtmpo9v1h0/file41b058f55d81 -V' had status 1
...
```
    ...
    ## Warning: There were 63 divergent transitions after warmup. Increasing adapt_delta above
    ## 0.95 may help. See http://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
...
(z_5\[1\])); lprior += student_t_lpdf(Intercept \| 3, 2.3, 3.4); lprior
...
```
    ...
    ## '"quarto" TMPDIR=C:/Users/LoVa3397/AppData/Local/Temp/Rtmpo9v1h0/file41b06f6e114a -V' had
    ## status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/LoVa3397/AppData/Local/Temp/Rtmpo9v1h0/file41b06f6e114a". Did you mean command "remove"? @ C:\\PROGRA~1\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────
