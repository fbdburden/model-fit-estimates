Global PAF of aflatoxin M1 - Fit model - Version 6
================
fbbu6966
2025-10-03
...
```
    ...
    ## The following objects are masked from 'package:mc2d':
    ## 
...
```
    ...
    ## 'data.frame':    779 obs. of  22 variables:
    ##  $ ISO3             : chr  "ALB" "ALB" "ALB" "ALB" ...
    ##  $ year             : num  2000 2000 2000 2000 2019 ...
    ##  $ country          : chr  "Albania" "Albania" "Albania" "Albania" ...
    ##  $ k                : num  6 8 7 5 2 1 3 4 1 6 ...
    ##  $ value            : num  0 0 0 0 11.4 ...
    ##  $ SOURCE_ID        : chr  "4" "4" "4" "4" ...
    ##  $ ROW_ID           : num  8 10 9 7 4 3 5 6 630 690 ...
    ##  $ SOURCE_YEAR      : num  2001 2001 2001 2001 2022 ...
    ##  $ REF_YEAR_START   : num  2000 2000 2000 2000 2019 ...
    ##  $ REF_YEAR_END     : num  2000 2000 2000 2000 2019 ...
    ##  $ REF_NOTES        : chr  "Skimmed and semi skimmed" "Skimmed and semi skimmed" "Whole milk" "Whole milk" ...
    ##  $ REF_LOCATION_ISO3: chr  "ALB" "ALB" "ALB" "ALB" ...
    ##  $ REG2             : chr  "EUR" "EUR" "EUR" "EUR" ...
    ##  $ SUB2             : chr  "EURB" "EURB" "EURB" "EURB" ...
    ##  $ BW               : num  69.4 69.4 69.4 69.4 69.4 ...
    ##  $ a_c              : num  0 0 0 0 0.164 ...
    ##  $ location_name    : chr  "Albania" "Albania" "Albania" "Albania" ...
    ##  $ p_c              : num  0.000486 0.000486 0.000486 0.000486 0.000348 ...
    ##  $ HCC_s            : num  7.5 7.5 7.5 7.5 11.6 ...
    ##  $ HCC_ac           : num  0 0 0 0 0.000281 ...
    ##  $ Excess_risk      : num  0 0 0 0 0.000281 ...
    ##  $ PAF_ac           : num  0.00 0.00 0.00 0.00 2.42e-05 ...

![](02-fit_v6-20251003_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->![](02-fit_v6-20251003_files/figure-gfm/unnamed-chunk-2-2.png)<!-- -->
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpUF9Glp/file383478aa7c5e -V' had status 1

``` r
es$DTP_ID<-as.character(seq(1:length(es$SOURCE_ID)))
# es$FLAG <- if_else(es$PAF_ac > 7e-08 & es$FLAG == 0,
#                    7,
#                    es$FLAG)
...
Values <- c("5000","3000","0.85","15","Year, countries","No", "Normal(0,1)")
...
```
    ...
    ## Warning: There were 12 divergent transitions after warmup. Increasing adapt_delta above 0.85 may help. See
    ## http://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup

    ##  Family: gaussian 
    ##   Links: mu = identity; sigma = identity 
    ## Formula: yi | 1 ~ 1 + YEAR + (1 | REG2) + (1 | REG2:SUB2) + (1 | REG2:SUB2:COUNTRY) + (1 | REG2:SUB2:COUNTRY:ID) 
    ##    Data: subset(es, as.integer(FLAG) == 1) (Number of observations: 525) 
    ...
    ## sd(Intercept)     0.99      0.56     0.06     2.16 1.00     3226     3762
    ## 
    ## ~REG2:SUB2 (Number of levels: 15) 
    ##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(Intercept)     1.45      0.40     0.73     2.30 1.00     3574     4557
    ## 
    ## ~REG2:SUB2:COUNTRY (Number of levels: 63) 
    ##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(Intercept)     1.45      0.20     1.09     1.86 1.00     3470     5719
    ## 
    ## ~REG2:SUB2:COUNTRY:ID (Number of levels: 181) 
    ##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(Intercept)     1.11      0.11     0.91     1.33 1.00     3166     5651
    ## 
    ## Regression Coefficients:
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept    43.98     27.34    -8.97    97.45 1.00     5077     6441
    ## YEAR         -0.03      0.01    -0.05    -0.00 1.00     5077     6507
    ## 
    ## Further Distributional Parameters:
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     1.01      0.04     0.93     1.09 1.00     6397     7294
    ## 
...
![](02-fit_v6-20251003_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->![](02-fit_v6-20251003_files/figure-gfm/unnamed-chunk-3-2.png)<!-- -->

``` r
plot(conditional_effects(fit_brms_reg_s6), points = TRUE, ask=FALSE)
```

![](02-fit_v6-20251003_files/figure-gfm/unnamed-chunk-3-3.png)<!-- -->
...
```
    ...
    ##   r_3_1 = (sd_3[1] * (z_3[1]));
    ##   r_4_1 = (sd_4[1] * (z_4[1]));
    ##   lprior += student_t_lpdf(Intercept | 3, -10.6, 2.7);
...
``` r
## save model fit
saveRDS(fit_brms_reg_s6, file = "fit_brms_reg_s6.rds")
```
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpUF9Glp/file383434ca3ba9 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpUF9Glp/file383434ca3ba9". Did you mean command "update"? @ C:\\PROGRA~1\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ────────────────────────────────────────────────────────────────────────────────────────────────
    ...
    ##    broom            1.0.8      2025-03-28 [1] CRAN (R 4.5.1)
