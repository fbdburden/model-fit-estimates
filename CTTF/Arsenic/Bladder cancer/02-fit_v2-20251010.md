Global PAF of arsenic - bladder cancer - Fit model - Version 2
================
fbbu6966
2025-10-10
...
![](02-fit_v2-20251010_files/figure-gfm/unnamed-chunk-2-9.png)<!-- -->![](02-fit_v2-20251010_files/figure-gfm/unnamed-chunk-2-10.png)<!-- -->
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp0MMjq5/file3e5867933a00 -V' had status 1
...
Values <- c("5000","3000",0.85,NA,"Year, countries, Studies","Yes", "Normal(0,1)")
...
```
    ...
    ## sd(Intercept)     0.92      0.53     0.06     2.07 1.00     4184     3791
    ## 
    ## ~REG2:SUB2 (Number of levels: 9) 
    ##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(Intercept)     0.83      0.50     0.04     1.94 1.00     3598     4119
    ## 
    ## ~REG2:SUB2:COUNTRY (Number of levels: 23) 
    ##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(Intercept)     0.69      0.37     0.04     1.42 1.00     1951     2625
    ## 
    ## ~REG2:SUB2:COUNTRY:ID (Number of levels: 29) 
    ##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(Intercept)     0.67      0.32     0.08     1.30 1.00     1897     2791
    ## 
    ## Regression Coefficients:
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept   113.98     94.51   -75.59   298.16 1.00     6360     7714
    ## YEAR         -0.06      0.05    -0.15     0.04 1.00     6358     7662
    ## 
    ## Further Distributional Parameters:
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.86      0.08     0.71     1.04 1.00     6377     7215
    ## 
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp0MMjq5/file3e5861be195d -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp0MMjq5/file3e5861be195d". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
