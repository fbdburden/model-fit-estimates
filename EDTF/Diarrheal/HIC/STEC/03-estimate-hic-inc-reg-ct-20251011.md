Global incidence of Shiga toxin-producing E. coli (Diarrheal) •
Estimates
================
fbbu6966
2025-10-11
...
```
    ...
    ##  $ VAL_MEAN     : num  796751 802484 808436 814715 821000 ...
    ##  $ VAL_LWR      : num  465604 468987 471751 475673 479194 ...
    ##  $ VAL_UPR      : num  1270717 1279006 1289638 1299784 1309510 ...
...
```
    ...
    ## 'data.frame':    22 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num [1:22(1d)] 75.4 75.4 75.5 75.6 75.6 ...
    ##  $ VAL_LWR      : num [1:22(1d)] 44.1 44.1 44.1 44.1 44.1 ...
    ##  $ VAL_UPR      : num [1:22(1d)] 120 120 120 121 121 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
...
```
    ...
    ##  $ VAL_MEAN     : num  0 372498 16222 359722 0 ...
    ##  $ VAL_LWR      : num  0 154480 3801 179927 0 ...
    ##  $ VAL_UPR      : num  0 740280 45509 635103 0 ...
...
```
    ...
    ## 'data.frame':    132 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2000 2000 2000 2000 2000 2001 2001 2001 2001 ...
    ##  $ VAL_MEAN     : num  NaN 111.1 65.9 72.5 NaN ...
    ##  $ VAL_LWR      : num  NaN 46.1 15.4 36.3 NaN ...
    ##  $ VAL_UPR      : num  NaN 221 185 128 NaN ...
    ##  $ LOCATION     : chr  "Region" "Region" "Region" "Region" ...
    ##  $ LOCATION_NAME: chr  "AFR" "AMR" "EMR" "EUR" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
```
    ...
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num  75.4 75.4 75.5 75.6 75.6 ...
    ##  $ VAL_LWR      : num  44.1 44.1 44.1 44.1 44.1 ...
    ##  $ VAL_UPR      : num  120 120 120 121 121 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
|------:|----------:|----------:|----------:|
| 2,010 | 862,066.7 | 502,412.1 | 1,376,803 |
| 2,020 | 924,751.0 | 536,994.3 | 1,477,205 |

Global number of Shiga toxin-producing E. coli cases, 2010 vs 2020
...
Incidence per 100.000 of Shiga toxin-producing E. coli by WHO region in
2020
</caption>
...
Cases of Shiga toxin-producing E. coli by WHO region in 2020
</caption>
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp4otTYi/file31a05e821e27 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp4otTYi/file31a05e821e27". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
