Global mortality of Shiga toxin-producing E. coli (Diarrheal) •
Estimates
================
fbbu6966
2025-12-08
...
```
    ...
    ## sd(Intercept)     0.55      0.44     0.02     1.67 1.00     3487     3861
    ## 
    ## ~REG2:ID (Number of levels: 13) 
    ##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(Intercept)     1.00      0.28     0.57     1.65 1.00     3868     5747
    ## 
    ## Regression Coefficients:
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept    -3.70      0.50    -4.76    -2.77 1.00     4413     4835
    ## 
...
```
    ...
    ##  $ VAL_MEAN     : num  317 319 321 323 325 ...
    ##  $ VAL_LWR      : num  146 147 148 149 150 ...
    ##  $ VAL_UPR      : num  588 591 596 599 604 ...
...
```
    ...
    ## 'data.frame':    22 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num [1:22(1d)] 0.03 0.03 0.03 0.03 0.03 ...
    ##  $ VAL_LWR      : num [1:22(1d)] 0.0138 0.0139 0.0139 0.0139 0.0139 ...
    ##  $ VAL_UPR      : num [1:22(1d)] 0.0557 0.0556 0.0556 0.0556 0.0556 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
...
```
    ...
    ##  $ VAL_MEAN     : num  0 101.69 6.86 162.95 0 ...
    ##  $ VAL_LWR      : num  0 40.96 2.12 57.18 0 ...
    ##  $ VAL_UPR      : num  0 208.6 15.4 372.5 0 ...
...
```
    ...
    ## 'data.frame':    132 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2000 2000 2000 2000 2000 2001 2001 2001 2001 ...
    ##  $ VAL_MEAN     : num  NaN 0.0303 0.0279 0.0328 NaN ...
    ##  $ VAL_LWR      : num  NaN 0.0122 0.0086 0.0115 NaN ...
    ##  $ VAL_UPR      : num  NaN 0.0622 0.0624 0.0751 NaN ...
    ##  $ LOCATION     : chr  "Region" "Region" "Region" "Region" ...
    ##  $ LOCATION_NAME: chr  "AFR" "AMR" "EMR" "EUR" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
```
    ...
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num  0.03 0.03 0.03 0.03 0.03 ...
    ##  $ VAL_LWR      : num  0.0138 0.0139 0.0139 0.0139 0.0139 ...
    ##  $ VAL_UPR      : num  0.0557 0.0556 0.0556 0.0556 0.0556 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
|------:|---------:|---------:|---------:|
| 2,010 | 339.8603 | 157.1937 | 629.8360 |
| 2,020 | 361.4027 | 168.0988 | 668.3517 |

Global number of Shiga toxin-producing E. coli deaths, 2010 vs 2020
...
Mortality per 100,000 of Shiga toxin-producing E. coli by WHO region in
2020
</caption>
...
Deaths of Shiga toxin-producing E. coli by WHO region in 2020
</caption>
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpQVcNE8/file423c30057eb7 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpQVcNE8/file423c30057eb7". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────────────────────
