Global incidence of Giardia (Diarrheal) • Estimates
================
fbbu6966
2025-05-09
...
```
    ...
    ##  $ VAL_MEAN     : num  4443875 4474280 4505854 4538473 4570785 ...
    ##  $ VAL_LWR      : num  2411686 2427024 2444018 2461397 2478808 ...
    ##  $ VAL_UPR      : num  7495486 7546759 7601050 7654843 7708212 ...
...
```
    ...
    ## 'data.frame':    22 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num [1:22(1d)] 420 421 421 421 421 ...
    ##  $ VAL_LWR      : num [1:22(1d)] 228 228 228 228 228 ...
    ##  $ VAL_UPR      : num [1:22(1d)] 709 710 710 710 710 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
...
```
    ...
    ##  $ VAL_MEAN     : num  0 1577262 110043 1714027 0 ...
    ##  $ VAL_LWR      : num  0 677175 41880 695727 0 ...
    ##  $ VAL_UPR      : num  0 3171865 255913 3322487 0 ...
...
```
    ...
    ## 'data.frame':    132 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2000 2000 2000 2000 2000 2001 2001 2001 2001 ...
    ##  $ VAL_MEAN     : num  NaN 470 447 345 NaN ...
    ##  $ VAL_LWR      : num  NaN 202 170 140 NaN ...
    ##  $ VAL_UPR      : num  NaN 946 1040 670 NaN ...
    ##  $ LOCATION     : chr  "Region" "Region" "Region" "Region" ...
    ##  $ LOCATION_NAME: chr  "AFR" "AMR" "EMR" "EUR" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
```
    ...
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num  420 421 421 421 421 ...
    ##  $ VAL_LWR      : num  228 228 228 228 228 ...
    ##  $ VAL_UPR      : num  709 710 710 710 710 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
|------:|----------:|----------:|----------:|
| 2,010 | 4,786,543 | 2,592,068 | 8,086,642 |
| 2,020 | 5,108,451 | 2,769,529 | 8,649,219 |

Global number of Giardia cases, 2010 vs 2020
...
<caption>
Incidence per 100.000 of Giardia by WHO region in 2020
</caption>
<thead>
<tr>
...
<table class="table table-striped" style="margin-left: auto; margin-right: auto;">
<caption>
Cases of Giardia by WHO region in 2020
</caption>
<thead>
<tr>
<th style="text-align:left;">
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmpw3c1xL/file2598735629aa -V' had status 1
    ...
    ##  pandoc   3.2 @ C:/Users/fbbu6966/AppData/Local/Programs/RStudio/resources/app/bin/quarto/bin/tools/ (via rmarkdown)
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmpw3c1xL/file2598735629aa". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────────────────────────────
