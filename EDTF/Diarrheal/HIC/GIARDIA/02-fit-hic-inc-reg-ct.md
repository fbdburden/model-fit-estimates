Diarrheal Incidence Giardia • Model fit
================
CaDi2575
2025-05-09
...
```
    ...
    ## TMPDIR=C:/Users/CaDi2575/AppData/Local/Temp/RtmpeYT1VJ/file353c77b126a4 -V' had status 1
...
```
    ...
    ## -15.1546   30.3092   34.3092   35.1050   35.8092   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    0.8250  0.9083     12     no      ID 
    ## 
    ## Test for Heterogeneity:
    ## Q(df = 11) = 1576135.3305, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ## estimate      se     tval  df    pval   ci.lb   ci.ub      
    ##   5.9752  0.2664  22.4271  11  <.0001  5.3888  6.5617  *** 
    ## 
    ## ---
...
```
    ...
    ## 
    ##   logLik  Deviance       AIC       BIC      AICc   
    ## -14.2575   28.5151   34.5151   35.4229   38.5151   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    0.9106  0.9543     12     no      ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 10) = 1103319.9284, p-val < .0001
    ## 
    ## Test of Moderators (coefficient 2):
    ## F(df1 = 1, df2 = 10) = 0.0061, p-val = 0.9393
    ## 
    ## Model Results:
    ## 
    ##          estimate       se     tval  df    pval      ci.lb     ci.ub    
    ## intrcpt   12.0172  77.3669   0.1553  10  0.8797  -160.3669  184.4013    
    ## YEAR      -0.0030   0.0385  -0.0781  10  0.9393    -0.0889    0.0829    
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Full     3 34.5151 35.4229 38.5151 -14.2575               1103319.9284 
    ## Reduced  2 34.3092 35.1050 35.8092 -15.1546 1.7941 0.1804 1576135.3305
...
```
    ...
    ## Warning: There were 1884 transitions after warmup that exceeded the maximum treedepth. Increase max_treedepth above 15. See
...
```
    ...
    ## sd(Intercept)     0.51      0.41     0.02     1.56 1.00     2693     3379
    ## 
    ## ~REG2:ID (Number of levels: 12) 
    ##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(Intercept)     0.96      0.23     0.62     1.50 1.00     2676     4375
    ## 
    ## Regression Coefficients:
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept     6.00      0.45     5.14     6.95 1.00     3563     4068
    ## 
...
```
    ...
    ##   r_1_1 = (sd_1[1] * (z_1[1]));
    ##   r_2_1 = (sd_2[1] * (z_2[1]));
    ##   lprior += student_t_lpdf(Intercept | 3, 6.2, 2.5);
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/CaDi2575/AppData/Local/Temp/RtmpeYT1VJ/file353c2d0432a1 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/CaDi2575/AppData/Local/Temp/RtmpeYT1VJ/file353c2d0432a1". Did you mean command "install"? @ C:\\PROGRA~1\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
