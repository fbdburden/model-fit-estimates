Diarrheal Incidence Norovirus • Model fit
================
CaDi2575
2025-05-08
...
```
    ...
    ## TMPDIR=C:/Users/CaDi2575/AppData/Local/Temp/Rtmp8ioRw4/file332c70dc2816 -V' had status 1
...
```
    ...
    ##  -9.9408   19.8816   23.8816   25.7705   24.6316   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    0.3018  0.5493     19     no      ID 
    ## 
    ## Test for Heterogeneity:
    ## Q(df = 19) = 5380772.1459, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ## estimate      se     tval  df    pval   ci.lb   ci.ub      
    ##   8.4994  0.1260  67.4415  19  <.0001  8.2357  8.7632  *** 
    ## 
    ## ---
...
```
    ...
    ## 
    ##   logLik  Deviance       AIC       BIC      AICc   
    ## -12.1202   24.2404   30.2404   32.9115   31.9546   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    0.3030  0.5505     19     no      ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 18) = 5376734.9952, p-val < .0001
    ## 
    ## Test of Moderators (coefficient 2):
    ## F(df1 = 1, df2 = 18) = 0.0353, p-val = 0.8530
    ## 
    ## Model Results:
    ## 
    ##          estimate      se    tval  df    pval    ci.lb    ci.ub    
    ## intrcpt    7.9174  3.0993  2.5546  18  0.0199   1.4061  14.4287  * 
    ## YEAR       0.0003  0.0015  0.1880  18  0.8530  -0.0029   0.0035    
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Full     3 30.2404 32.9115 31.9546 -12.1202               5376734.9952 
    ## Reduced  2 23.8816 25.7705 24.6316  -9.9408 0.0000 1.0000 5380772.1459
...
![](02-fit-hic-inc-glb-yr_files/figure-gfm/r_lineartimetrend.png)
...
![](02-fit-hic-inc-glb-yr_files/figure-gfm/r_nonlineartimetrend.png)
...
```
    ...
    ## Warning: There were 222 transitions after warmup that exceeded the maximum treedepth. Increase max_treedepth above 15. See
...
```
    ...
    ## Formula: yi | se(sei) ~ 1 + YEAR + (1 | ID) 
    ##    Data: subset(es, as.integer(FLAG) == 1) (Number of observations: 20) 
    ...
    ## sd(Intercept)     0.58      0.10     0.42     0.82 1.01      662     1265
    ## 
    ## Regression Coefficients:
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept     7.92      3.09     2.02    13.99 1.00     3004     3007
    ## YEAR          0.00      0.00    -0.00     0.00 1.00     2988     3008
    ## 
...
![](02-fit-hic-inc-glb-yr_files/figure-gfm/r_summary-1.png)![](02-fit-hic-inc-glb-yr_files/figure-gfm/r_summary-2.png)![](02-fit-hic-inc-glb-yr_files/figure-gfm/r_summary-3.png)![](02-fit-hic-inc-glb-yr_files/figure-gfm/r_summary-4.png)
...
![](02-fit-hic-inc-glb-yr_files/figure-gfm/r_conditional_effects-1.png)<!-- -->
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/CaDi2575/AppData/Local/Temp/Rtmp8ioRw4/file332c601216a5 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/CaDi2575/AppData/Local/Temp/Rtmp8ioRw4/file332c601216a5". Did you mean command "remove"? @ C:\\PROGRA~1\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
