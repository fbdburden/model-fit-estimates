Global mortality of Norovirus (Diarrheal) • Estimates
================
fbbu6966
2025-12-08
...
```
    ...
    ##    Data: subset(es, as.integer(FLAG) == 1) (Number of observations: 17) 
    ...
    ## sd(Intercept)     0.92      0.46     0.18     2.02 1.00     3475     2434
    ## 
    ## ~REG2:ID (Number of levels: 16) 
    ##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(Intercept)     0.87      0.21     0.55     1.37 1.00     2758     4771
    ## 
    ## Regression Coefficients:
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept    -1.79      0.60    -3.01    -0.57 1.00     4310     4510
    ## 
...
```
    ...
    ##  $ VAL_MEAN     : num  2545 2559 2573 2590 2606 ...
    ##  $ VAL_LWR      : num  1467 1474 1484 1494 1505 ...
    ##  $ VAL_UPR      : num  4053 4074 4097 4123 4149 ...
...
```
    ...
    ## 'data.frame':    22 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num [1:22(1d)] 0.241 0.241 0.24 0.24 0.24 ...
    ##  $ VAL_LWR      : num [1:22(1d)] 0.139 0.139 0.139 0.139 0.139 ...
    ##  $ VAL_UPR      : num [1:22(1d)] 0.384 0.383 0.383 0.382 0.382 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
...
```
    ...
    ##  $ VAL_MEAN     : num  0 587.1 49.3 1728.9 0 ...
    ##  $ VAL_LWR      : num  0 245.4 12.1 813 0 ...
    ##  $ VAL_UPR      : num  0 1191 139 3042 0 ...
...
```
    ...
    ## 'data.frame':    132 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2000 2000 2000 2000 2000 2001 2001 2001 2001 ...
    ##  $ VAL_MEAN     : num  NaN 0.175 0.201 0.348 NaN ...
    ##  $ VAL_LWR      : num  NaN 0.0732 0.0492 0.1638 NaN ...
    ##  $ VAL_UPR      : num  NaN 0.355 0.565 0.613 NaN ...
    ##  $ LOCATION     : chr  "Region" "Region" "Region" "Region" ...
    ##  $ LOCATION_NAME: chr  "AFR" "AMR" "EMR" "EUR" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
```
    ...
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num  0.241 0.241 0.24 0.24 0.24 ...
    ##  $ VAL_LWR      : num  0.139 0.139 0.139 0.139 0.139 ...
    ##  $ VAL_UPR      : num  0.384 0.383 0.383 0.382 0.382 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
|------:|----------:|----------:|----------:|
| 2,010 | 2,712.615 | 1,567.906 | 4,321.722 |
| 2,020 | 2,864.348 | 1,659.348 | 4,559.794 |

Global number of Norovirus deaths, 2010 vs 2020
...
Mortality per 100,000 of Norovirus by WHO region in 2020
</caption>
...
Deaths of Norovirus by WHO region in 2020
</caption>
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp4MKj4c/file22f4aff136e -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp4MKj4c/file22f4aff136e". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────────────────────
