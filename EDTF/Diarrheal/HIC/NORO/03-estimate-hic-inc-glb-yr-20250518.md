Global incidence of Norovirus (Diarrheal) • Estimates
================
BrDe394
2025-05-18
...
fit_brms_reg_s <- readRDS(file.path(params$Dir, "fit_brms_inc_glb_yr.rds"))
...
saveRDS(sim_all, sprintf("%s/sim_all_inc_glb_yr_%s.rds", params$Dir, bd::today()))
...
```
    ...
    ##  $ VAL_MEAN     : num  52033419 52382250 52746061 53129046 53509530 ...
    ##  $ VAL_LWR      : num  39132079 39420627 39705362 40000710 40243035 ...
    ##  $ VAL_UPR      : num  66827339 67217983 67670879 68109817 68569247 ...
...
```
    ...
    ## 'data.frame':    22 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num [1:22(1d)] 4924 4925 4926 4928 4929 ...
    ##  $ VAL_LWR      : num [1:22(1d)] 3703 3706 3708 3710 3707 ...
    ##  $ VAL_UPR      : num [1:22(1d)] 6323 6320 6320 6317 6316 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
...
```
    ...
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num  4924 4925 4926 4928 4929 ...
    ##  $ VAL_LWR      : num  3703 3706 3708 3710 3707 ...
    ##  $ VAL_UPR      : num  6323 6320 6320 6317 6316 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
|------:|-----------:|-----------:|-----------:|
| 2,010 | 56,028,767 | 42,045,394 | 71,644,367 |
| 2,020 | 59,789,828 | 45,001,494 | 77,053,274 |

Global number of Norovirus cases, 2010 vs 2020
...
| YEAR | VAL_MEAN |  VAL_LWR |  VAL_UPR |
|-----:|---------:|---------:|---------:|
| 2010 | 4937.255 | 3705.040 | 6313.302 |
| 2020 | 4952.125 | 3727.274 | 6381.980 |

Global incidence per 100.000 of Norovirus cases, 2010 vs 2020
...
```
    ...
    ## TMPDIR=C:/Users/BrDe394/AppData/Local/Temp/RtmpIDoWbz/file3a506405b3c -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/BrDe394/AppData/Local/Temp/RtmpIDoWbz/file3a506405b3c". Did you mean command "create"? @ C:\\Users\\BrDe394\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ────────────────────────────────────────────────────────────────────────────────────────────────────────────
