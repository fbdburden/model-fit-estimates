Global mortality of Cryptosporidium (Diarrheal) • Estimate
================
fbbu6966
2025-12-08
...
fit_brms_reg_s <- readRDS(file.path(params$Dir, "fit_brms_mrt_glb_ct.rds"))
...
```
    ...
    ##    Data: subset(es, as.integer(FLAG) == 1) (Number of observations: 9) 
    ##   Draws: 5 chains, each with iter = 5000; warmup = 3000; thin = 1;
    ##          total post-warmup draws = 10000
    ## 
    ## Multilevel Hyperparameters:
    ## ~ID (Number of levels: 9) 
    ##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(Intercept)     0.60      0.30     0.14     1.31 1.00     2151     3207
    ## 
    ## Regression Coefficients:
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept    -4.02      0.29    -4.69    -3.50 1.00     3001     3062
    ## 
...
saveRDS(sim_all, sprintf("%s/sim_all_mrt_glb_ct_%s.rds", params$Dir, bd::today()))
...
```
    ...
    ##  $ VAL_MEAN     : num  199 200 201 203 204 ...
    ##  $ VAL_LWR      : num  97 97.6 98.2 98.9 99.6 ...
    ##  $ VAL_UPR      : num  320 322 324 326 329 ...
...
```
    ...
    ## 'data.frame':    22 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num [1:22(1d)] 0.0188 0.0188 0.0188 0.0188 0.0188 ...
    ##  $ VAL_LWR      : num [1:22(1d)] 0.00917 0.00917 0.00917 0.00917 0.00917 ...
    ##  $ VAL_UPR      : num [1:22(1d)] 0.0303 0.0303 0.0303 0.0303 0.0303 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
...
```
    ...
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num  0.0188 0.0188 0.0188 0.0188 0.0188 ...
    ##  $ VAL_LWR      : num  0.00917 0.00917 0.00917 0.00917 0.00917 ...
    ##  $ VAL_UPR      : num  0.0303 0.0303 0.0303 0.0303 0.0303 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
|------:|---------:|---------:|---------:|
| 2,010 | 213.2308 | 104.1160 | 343.4060 |
| 2,020 | 226.8611 | 110.7714 | 365.3575 |

Global number of Cryptosporidium deaths, 2010 vs 2020

``` r
kable(
  caption = paste0("Global mortality per 100.000 of ",params$Pathogen," , 2010 vs 2020"),
  row.names = FALSE,
...
| YEAR |  VAL_MEAN |   VAL_LWR |    VAL_UPR |
|-----:|----------:|----------:|-----------:|
| 2010 | 0.0187899 | 0.0091747 | 0.03026094 |
| 2020 | 0.0187899 | 0.0091747 | 0.03026094 |

Global mortality per 100.000 of Cryptosporidium , 2010 vs 2020
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp2TyNae/file248441e1a61 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp2TyNae/file248441e1a61". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────────────────────
