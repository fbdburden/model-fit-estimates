Diarrheal Mortality Cryptosporidium • Model fit
================
fbbu6966
2025-12-08
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp2TyNae/file2484152f6c53 -V' had status 1
...
```
    ...
    ## -10.5472   21.0944   25.0944   25.2533   27.4944   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    0.2550  0.5050      9     no      ID 
    ## 
    ## Test for Heterogeneity:
    ## Q(df = 8) = 22.8423, p-val = 0.0036
    ## 
    ## Model Results:
    ## 
    ## estimate      se      tval  df    pval    ci.lb    ci.ub      
    ##  -3.9759  0.2360  -16.8504   8  <.0001  -4.5200  -3.4318  *** 
    ## 
    ## ---
...
```
    ...
    ## 
    ##   logLik  Deviance       AIC       BIC      AICc   
    ##  -9.7604   19.5209   25.5209   25.3586   33.5209   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    0.3868  0.6219      9     no      ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 7) = 22.8407, p-val = 0.0018
    ## 
    ## Test of Moderators (coefficient 2):
    ## F(df1 = 1, df2 = 7) = 0.6169, p-val = 0.4580
    ## 
    ## Model Results:
    ## 
    ##          estimate       se     tval  df    pval      ci.lb    ci.ub    
    ## intrcpt  -53.9436  63.5650  -0.8486   7  0.4242  -204.2508  96.3637    
    ## YEAR       0.0248   0.0316   0.7854   7  0.4580    -0.0499   0.0996    
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Full     3 25.5209 25.3586 33.5209  -9.7604               22.8407 
    ## Reduced  2 25.0944 25.2533 27.4944 -10.5472 1.5735 0.2097 22.8423
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp2TyNae/file248420543aea -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp2TyNae/file248420543aea". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────────────────────
