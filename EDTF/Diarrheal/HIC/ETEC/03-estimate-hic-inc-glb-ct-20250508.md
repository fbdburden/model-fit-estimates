Global incidence of Enterotoxigenic E. coli (Diarrheal) • Estimates
================
CaDi2575
2025-05-08
...
fit_brms_reg_s <- readRDS(file.path(params$Dir, "fit_brms_inc_glb_ct.rds"))
...
```
    ...
    ## sd(Intercept)     1.29      0.41     0.69     2.25 1.00     1694     2309
    ## 
    ## Regression Coefficients:
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept     3.51      0.64     2.21     4.77 1.00     1618     1851
    ## 
...
saveRDS(sim_all, sprintf("%s/sim_all_inc_glb_ct_%s.rds", params$Dir, bd::today()))
...
```
    ...
    ##  $ VAL_MEAN     : num  437146 439959 442895 445990 449061 ...
    ##  $ VAL_LWR      : num  96110 96729 97374 98055 98730 ...
    ##  $ VAL_UPR      : num  1241265 1249253 1257591 1266379 1275099 ...
...
```
    ...
    ## 'data.frame':    22 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num [1:22(1d)] 41.4 41.4 41.4 41.4 41.4 ...
    ##  $ VAL_LWR      : num [1:22(1d)] 9.09 9.09 9.09 9.09 9.09 ...
    ##  $ VAL_UPR      : num [1:22(1d)] 117 117 117 117 117 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
...
```
    ...
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num  41.4 41.4 41.4 41.4 41.4 ...
    ##  $ VAL_LWR      : num  9.09 9.09 9.09 9.09 9.09 ...
    ##  $ VAL_UPR      : num  117 117 117 117 117 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
|------:|----------:|----------:|----------:|
| 2,010 | 469,408.2 | 103,203.2 | 1,332,874 |
| 2,020 | 499,414.2 | 109,800.3 | 1,418,076 |

Global number of Enterotoxigenic E. coli cases, 2010 vs 2020

``` r
kable(
  caption = paste0("Global incidence per 100.000 of ",params$Pathogen," cases, 2010 vs 2020"),
  row.names = FALSE,
...
| YEAR | VAL_MEAN |  VAL_LWR |  VAL_UPR |
|-----:|---------:|---------:|---------:|
| 2010 | 41.36425 | 9.094267 | 117.4529 |
| 2020 | 41.36425 | 9.094267 | 117.4529 |

Global incidence per 100.000 of Enterotoxigenic E. coli cases, 2010 vs
2020
...
```
    ...
    ## TMPDIR=C:/Users/CaDi2575/AppData/Local/Temp/Rtmp4kwlEq/fileac4500b46c8 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/CaDi2575/AppData/Local/Temp/Rtmp4kwlEq/fileac4500b46c8". Did you mean command "install"? @ C:\\PROGRA~1\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ─────────────────────────────────────────────────────────────────────────────────────────────────────────────
