Diarrheal Incidence Campylobacter • Model fit
================
fbbu6966
2025-10-11
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpGq2HuE/file43d04e6f5e9d -V' had status 1
...
```
    ...
    ## -1250829.4177   2501658.8354   2501662.8354   2501665.8284   2501663.2354   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    0.4269  0.6534     27     no      ID 
    ## 
    ## Test for Heterogeneity:
    ## Q(df = 33) = 9569750.0356, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ## estimate      se     tval  df    pval   ci.lb   ci.ub      
    ##   6.7580  0.1259  53.6770  33  <.0001  6.5019  7.0142  *** 
    ## 
    ## ---
...
```
    ...
    ## 
    ##        logLik       Deviance            AIC            BIC           AICc   
    ## -1250829.8993   2501659.7986   2501665.7986   2501670.1958   2501666.6557   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    0.4413  0.6643     27     no      ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 32) = 9568849.9743, p-val < .0001
    ## 
    ## Test of Moderators (coefficient 2):
    ## F(df1 = 1, df2 = 32) = 1.6106, p-val = 0.2136
    ## 
    ## Model Results:
    ## 
    ##          estimate      se     tval  df    pval     ci.lb    ci.ub    
    ## intrcpt   -0.2495  5.5233  -0.0452  32  0.9642  -11.5001  11.0010    
    ## YEAR       0.0035  0.0027   1.2691  32  0.2136   -0.0021   0.0091    
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Full     3 2501665.7986 2501670.1958 2501666.6557 -1250829.8993               9568849.9743 
    ## Reduced  2 2501662.8354 2501665.8284 2501663.2354 -1250829.4177 0.0000 1.0000 9569750.0356
...
![](02-fit-hic-inc-reg-yr_files/figure-gfm/r_lineartimetrend.png)
...
![](02-fit-hic-inc-reg-yr_files/figure-gfm/r_nonlineartimetrend.png)
...
```
    ...
    ## Warning: There were 7396 transitions after warmup that exceeded the maximum treedepth. Increase max_treedepth above 15. See
...
![](02-fit-hic-inc-reg-yr_files/figure-gfm/r_summary-1.png)![](02-fit-hic-inc-reg-yr_files/figure-gfm/r_summary-2.png)![](02-fit-hic-inc-reg-yr_files/figure-gfm/r_summary-3.png)![](02-fit-hic-inc-reg-yr_files/figure-gfm/r_summary-4.png)![](02-fit-hic-inc-reg-yr_files/figure-gfm/r_summary-5.png)
...
![](/02-fit-hic-inc-reg-yr_files/figure-gfm/r_conditional_effects-1.png)<!-- -->
...
```
    ...
    ##   r_1_1 = (sd_1[1] * (z_1[1]));
    ##   r_2_1 = (sd_2[1] * (z_2[1]));
    ##   lprior += student_t_lpdf(Intercept | 3, 6.9, 2.5);
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpGq2HuE/file43d0730543e6 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpGq2HuE/file43d0730543e6". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
