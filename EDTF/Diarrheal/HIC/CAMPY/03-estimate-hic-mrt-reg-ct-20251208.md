Global mortality of Campylobacter (Diarrheal) • Estimates
================
fbbu6966
2025-12-08
...
```
    ...
    ## Warning: There were 18 divergent transitions after warmup. Increasing adapt_delta above 0.9 may help. See
    ## http://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup

    ##  Family: gaussian 
    ##   Links: mu = identity; sigma = identity 
    ## Formula: yi | se(sei) ~ 1 + (1 | REG2) + (1 | REG2:ID) 
    ##    Data: subset(es, as.integer(FLAG) == 1) (Number of observations: 19) 
    ...
    ## sd(Intercept)     1.06      0.47     0.31     2.19 1.00     3550     2938
    ## 
    ## ~REG2:ID (Number of levels: 18) 
    ##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(Intercept)     0.93      0.20     0.63     1.39 1.00     3271     5051
    ## 
    ## Regression Coefficients:
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept    -2.79      0.68    -4.23    -1.41 1.00     4446     4737
    ## 
...
```
    ...
    ##  $ VAL_MEAN     : num  1136 1142 1148 1155 1162 ...
    ##  $ VAL_LWR      : num  623 627 631 634 638 ...
    ##  $ VAL_UPR      : num  1832 1840 1848 1861 1874 ...
...
```
    ...
    ## 'data.frame':    22 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num [1:22(1d)] 0.108 0.107 0.107 0.107 0.107 ...
    ##  $ VAL_LWR      : num [1:22(1d)] 0.059 0.059 0.0589 0.0588 0.0588 ...
    ##  $ VAL_UPR      : num [1:22(1d)] 0.173 0.173 0.173 0.173 0.173 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
...
```
    ...
    ##  $ VAL_MEAN     : num  0 205.9 19.1 850.4 0 ...
    ##  $ VAL_LWR      : num  0 81.11 3.59 384.68 0 ...
    ##  $ VAL_UPR      : num  0 435.5 59.9 1510.2 0 ...
...
```
    ...
    ## 'data.frame':    132 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2000 2000 2000 2000 2000 2001 2001 2001 2001 ...
    ##  $ VAL_MEAN     : num  NaN 0.0614 0.0774 0.1714 NaN ...
    ##  $ VAL_LWR      : num  NaN 0.0242 0.0146 0.0775 NaN ...
    ##  $ VAL_UPR      : num  NaN 0.13 0.243 0.304 NaN ...
    ##  $ LOCATION     : chr  "Region" "Region" "Region" "Region" ...
    ##  $ LOCATION_NAME: chr  "AFR" "AMR" "EMR" "EUR" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
```
    ...
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num  0.108 0.107 0.107 0.107 0.107 ...
    ##  $ VAL_LWR      : num  0.059 0.059 0.0589 0.0588 0.0588 ...
    ##  $ VAL_UPR      : num  0.173 0.173 0.173 0.173 0.173 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
|------:|----------:|---------:|----------:|
| 2,010 | 1,205.932 | 661.9703 | 1,945.347 |
| 2,020 | 1,267.697 | 698.2485 | 2,037.126 |

Global number of Campylobacter deaths, 2010 vs 2020
...
Mortality per 100,000 of Campylobacter by WHO region in 2020
</caption>
...
Deaths of Campylobacter by WHO region in 2020
</caption>
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpQBpD0c/file34087db11dde -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpQBpD0c/file34087db11dde". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ──────────────────────────────────────────────────────────────────────────────────────────────
