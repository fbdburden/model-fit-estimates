Diarrheal Mortality Campylobacter • Model fit
================
fbbu6966
2025-12-08
...
```
    ...
    ## '"quarto" TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpQBpD0c/file3408546018b7 -V' had
    ## status 1
...
```
    ...
    ## -30.4378   60.8756   64.8756   66.6563   65.6756   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    1.4748  1.2144     18     no      ID 
    ## 
    ## Test for Heterogeneity:
    ## Q(df = 18) = 805.5870, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ## estimate      se     tval  df    pval    ci.lb    ci.ub      
    ##  -2.4934  0.3038  -8.2064  18  <.0001  -3.1317  -1.8551  *** 
    ## 
    ## ---
...
```
    ...
    ## 
    ##   logLik  Deviance       AIC       BIC      AICc   
    ## -27.8629   55.7259   61.7259   64.2255   63.5720   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    1.2818  1.1322     18     no      ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 17) = 532.4262, p-val < .0001
    ## 
    ## Test of Moderators (coefficient 2):
    ## F(df1 = 1, df2 = 17) = 3.1019, p-val = 0.0962
    ## 
    ## Model Results:
    ## 
    ##           estimate       se     tval  df    pval      ci.lb    ci.ub    
    ## intrcpt  -141.0058  78.6537  -1.7927  17  0.0908  -306.9505  24.9389  . 
    ## YEAR        0.0688   0.0391   1.7612  17  0.0962    -0.0136   0.1513  . 
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Full     3 61.7259 64.2255 63.5720 -27.8629               532.4262 
    ## Reduced  2 64.8756 66.6563 65.6756 -30.4378 5.1497 0.0233 805.5870
...
```
    ...
    ## Warning: There were 18 divergent transitions after warmup. Increasing adapt_delta above 0.9 may
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command
    ## '"quarto" TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpQBpD0c/file340857e55f3 -V' had status
    ## 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpQBpD0c/file340857e55f3". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────────
