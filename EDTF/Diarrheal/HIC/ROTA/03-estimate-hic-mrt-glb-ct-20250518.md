Global mortality of Rotavirus (Diarrheal) • Estimate
================
BrDe394
2025-05-18
...
```
    ...
    ##  $ VAL_MEAN     : num  338 340 342 345 347 ...
    ##  $ VAL_LWR      : num  74.2 74.7 75.2 75.7 76.2 ...
    ##  $ VAL_UPR      : num  919 925 931 938 944 ...
...
```
    ...
    ## 'data.frame':    22 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num [1:22(1d)] 0.032 0.032 0.032 0.032 0.032 ...
    ##  $ VAL_LWR      : num [1:22(1d)] 0.00702 0.00702 0.00702 0.00702 0.00702 ...
    ##  $ VAL_UPR      : num [1:22(1d)] 0.087 0.087 0.087 0.087 0.087 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
...
```
    ...
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num  0.032 0.032 0.032 0.032 0.032 ...
    ##  $ VAL_LWR      : num  0.00702 0.00702 0.00702 0.00702 0.00702 ...
    ##  $ VAL_UPR      : num  0.087 0.087 0.087 0.087 0.087 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
|------:|---------:|---------:|-----------:|
| 2,010 | 362.6334 | 79.69231 |   987.0546 |
| 2,020 | 385.8140 | 84.78648 | 1,050.1500 |

Global number of Rotavirus deaths, 2010 vs 2020
...
| YEAR |   VAL_MEAN |     VAL_LWR |    VAL_UPR |
|-----:|-----------:|------------:|-----------:|
| 2010 | 0.03195526 | 0.007022487 | 0.08697926 |
| 2020 | 0.03195526 | 0.007022487 | 0.08697926 |

Global mortality per 100.000 of Rotavirus , 2010 vs 2020
...
```
    ...
    ## TMPDIR=C:/Users/BrDe394/AppData/Local/Temp/RtmpY7pyYw/file3cd825687aba -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/BrDe394/AppData/Local/Temp/RtmpY7pyYw/file3cd825687aba". Did you mean command "create"? @ C:\\Users\\BrDe394\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ────────────────────────────────────────────────────────────────────────────────────────────────────────────
