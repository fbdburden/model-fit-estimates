Diarrheal Incidence Rotavirus • Model fit
================
CaDi2575
2025-05-08
...
```
    ...
    ## TMPDIR=C:/Users/CaDi2575/AppData/Local/Temp/RtmpuYC6II/file21f05398c26 -V' had status 1
...
```
    ...
    ## -12.3505   24.7009   28.7009   29.4967   30.2009   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    0.5474  0.7398     12     no      ID 
    ## 
    ## Test for Heterogeneity:
    ## Q(df = 11) = 3289811.6617, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ## estimate      se     tval  df    pval   ci.lb   ci.ub      
    ##   6.9707  0.2141  32.5549  11  <.0001  6.4994  7.4420  *** 
    ## 
    ## ---
...
```
    ...
    ## 
    ##   logLik  Deviance       AIC       BIC      AICc   
    ## -11.6562   23.3124   29.3124   30.2202   33.3124   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    0.5980  0.7733     12     no      ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 10) = 2534429.4113, p-val < .0001
    ## 
    ## Test of Moderators (coefficient 2):
    ## F(df1 = 1, df2 = 10) = 0.0925, p-val = 0.7672
    ## 
    ## Model Results:
    ## 
    ##          estimate       se     tval  df    pval      ci.lb     ci.ub    
    ## intrcpt  -11.0568  59.2639  -0.1866  10  0.8557  -143.1051  120.9914    
    ## YEAR       0.0090   0.0295   0.3042  10  0.7672    -0.0568    0.0748    
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Full     3 29.3124 30.2202 33.3124 -11.6562               2534429.4113 
    ## Reduced  2 28.7009 29.4967 30.2009 -12.3505 1.3885 0.2387 3289811.6617
...
![](02-fit-hic-inc-reg-ct_files/figure-gfm/r_lineartimetrend.png)
...
![](02-fit-hic-inc-reg-ct_files/figure-gfm/r_nonlineartimetrend.png)
...
```
    ...
    ## Warning: There were 3258 transitions after warmup that exceeded the maximum treedepth. Increase max_treedepth above 15. See
...
```
    ...
    ##    Data: subset(es, as.integer(FLAG) == 1) (Number of observations: 12) 
    ...
    ## sd(Intercept)     0.56      0.42     0.03     1.63 1.00     1268     1857
    ## 
    ## ~REG2:ID (Number of levels: 12) 
    ##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(Intercept)     0.76      0.19     0.49     1.22 1.00     2757     3945
    ## 
    ## Regression Coefficients:
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept     6.91      0.43     6.01     7.81 1.00     3008     3489
    ## 
...
![](02-fit-hic-inc-reg-ct_files/figure-gfm/r_summary-1.png)![](02-fit-hic-inc-reg-ct_files/figure-gfm/r_summary-2.png)![](02-fit-hic-inc-reg-ct_files/figure-gfm/r_summary-3.png)![](02-fit-hic-inc-reg-ct_files/figure-gfm/r_summary-4.png)
...
```
    ...
    ##   r_1_1 = (sd_1[1] * (z_1[1]));
    ##   r_2_1 = (sd_2[1] * (z_2[1]));
    ##   lprior += student_t_lpdf(Intercept | 3, 7.1, 2.5);
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/CaDi2575/AppData/Local/Temp/RtmpuYC6II/file21f06e515383 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/CaDi2575/AppData/Local/Temp/RtmpuYC6II/file21f06e515383". Did you mean command "install"? @ C:\\PROGRA~1\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ─────────────────────────────────────────────────────────────────────────────────────────────────────────────
