Diarrheal Mortality Rotavirus • Model fit
================
CaDi2575
2025-05-08
...
```
    ...
    ## TMPDIR=C:/Users/CaDi2575/AppData/Local/Temp/RtmpuYC6II/file21f010f37e7e -V' had status 1
...
```
    ...
    ## -14.9617   29.9234   33.9234   33.8152   36.9234   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    3.6541  1.9116      8     no      ID 
    ## 
    ## Test for Heterogeneity:
    ## Q(df = 7) = 425.2224, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ## estimate      se     tval  df    pval    ci.lb    ci.ub     
    ##  -3.6312  0.7207  -5.0387   7  0.0015  -5.3353  -1.9271  ** 
    ## 
    ## ---
...
```
    ...
    ## 
    ##   logLik  Deviance       AIC       BIC      AICc   
    ## -13.0845   26.1691   32.1691   31.5444   44.1691   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    3.9034  1.9757      8     no      ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 6) = 269.6653, p-val < .0001
    ## 
    ## Test of Moderators (coefficient 2):
    ## F(df1 = 1, df2 = 6) = 0.5324, p-val = 0.4931
    ## 
    ## Model Results:
    ## 
    ##           estimate        se     tval  df    pval      ci.lb     ci.ub    
    ## intrcpt  -142.9486  190.9131  -0.7488   6  0.4823  -610.0960  324.1988    
    ## YEAR        0.0693    0.0949   0.7297   6  0.4931    -0.1630    0.3016    
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Full     3 32.1691 31.5444 44.1691 -13.0845               269.6653 
    ## Reduced  2 33.9234 33.8152 36.9234 -14.9617 3.7543 0.0527 425.2224
...
![](02-fit-hic-mrt-glb-ct_files/figure-gfm/r_lineartimetrend.png)
...
![](02-fit-hic-mrt-glb-ct_files/figure-gfm/r_nonlineartimetrend.png)
...
```
    ...
    ##    Data: subset(es, as.integer(FLAG) == 1) (Number of observations: 8) 
    ##   Draws: 5 chains, each with iter = 5000; warmup = 3000; thin = 1;
    ##          total post-warmup draws = 10000
    ## 
    ## Multilevel Hyperparameters:
    ## ~ID (Number of levels: 8) 
    ##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(Intercept)     1.70      0.39     1.07     2.60 1.00     3020     4531
    ## 
    ## Regression Coefficients:
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept    -3.64      0.64    -4.96    -2.44 1.00     2470     3627
    ## 
...
![](02-fit-hic-mrt-glb-ct_files/figure-gfm/r_summary-1.png)![](02-fit-hic-mrt-glb-ct_files/figure-gfm/r_summary-2.png)![](02-fit-hic-mrt-glb-ct_files/figure-gfm/r_summary-3.png)
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/CaDi2575/AppData/Local/Temp/RtmpuYC6II/file21f02e5633e3 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/CaDi2575/AppData/Local/Temp/RtmpuYC6II/file21f02e5633e3". Did you mean command "install"? @ C:\\PROGRA~1\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ─────────────────────────────────────────────────────────────────────────────────────────────────────────────
