Global incidence of Rotavirus (Diarrheal) • Estimates
================
BrDe394
2025-05-18
...
``` r
zero_cases <-
  read_xlsx("//sciensano.be/fs/11401_LifeChron_FERG_DWH/Estimates/00_ADMIN/endemic_countries.xlsx")%>%
...
```
    ...
    ##  $ VAL_MEAN     : num  11683044 11763265 11846717 11934405 12021744 ...
    ##  $ VAL_LWR      : num  7238091 7283304 7330237 7380790 7439904 ...
    ##  $ VAL_UPR      : num  17930997 18046539 18167151 18297633 18432969 ...
...
```
    ...
    ## 'data.frame':    22 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num [1:22(1d)] 1105 1106 1106 1107 1107 ...
    ##  $ VAL_LWR      : num [1:22(1d)] 685 685 685 685 685 ...
    ##  $ VAL_UPR      : num [1:22(1d)] 1697 1697 1697 1697 1698 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
...
```
    ...
    ##  $ VAL_MEAN     : num  0 4525482 270710 5229449 0 ...
    ##  $ VAL_LWR      : num  0 2297023 99818 2804119 0 ...
    ##  $ VAL_UPR      : num  0 7959196 607812 9055665 0 ...
...
```
    ...
    ## 'data.frame':    132 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2000 2000 2000 2000 2000 2001 2001 2001 2001 ...
    ##  $ VAL_MEAN     : num  NaN 1350 1100 1054 NaN ...
    ##  $ VAL_LWR      : num  NaN 685 406 565 NaN ...
    ##  $ VAL_UPR      : num  NaN 2374 2469 1825 NaN ...
    ##  $ LOCATION     : chr  "Region" "Region" "Region" "Region" ...
    ##  $ LOCATION_NAME: chr  "AFR" "AMR" "EMR" "EUR" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
```
    ...
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num  1105 1106 1106 1107 1107 ...
    ##  $ VAL_LWR      : num  685 685 685 685 685 ...
    ##  $ VAL_UPR      : num  1697 1697 1697 1697 1698 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
|------:|-----------:|----------:|-----------:|
| 2,010 | 12,598,302 | 7,783,991 | 19,309,581 |
| 2,020 | 13,462,745 | 8,318,835 | 20,609,324 |

Global number of Rotavirus cases, 2010 vs 2020
...
<caption>
Incidence per 100.000 of Rotavirus by WHO region in 2020
</caption>
<thead>
<tr>
...
<table class="table table-striped" style="margin-left: auto; margin-right: auto;">
<caption>
Cases of Rotavirus by WHO region in 2020
</caption>
<thead>
<tr>
<th style="text-align:left;">
...
```
    ...
    ## TMPDIR=C:/Users/BrDe394/AppData/Local/Temp/RtmpY7pyYw/file3cd8341b2e5a -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/BrDe394/AppData/Local/Temp/RtmpY7pyYw/file3cd8341b2e5a". Did you mean command "create"? @ C:\\Users\\BrDe394\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ────────────────────────────────────────────────────────────────────────────────────────────────────────────
