Global incidence of Cyclospora (Diarrheal) • Estimates
================
CaDi2575
2025-05-08
...
```
    ...
    ##  $ VAL_MEAN     : num  122769 123559 124384 125253 126116 ...
    ##  $ VAL_LWR      : num  29660 29851 30050 30260 30468 ...
    ##  $ VAL_UPR      : num  334806 336960 339209 341580 343932 ...
...
```
    ...
    ## 'data.frame':    22 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num [1:22(1d)] 11.6 11.6 11.6 11.6 11.6 ...
    ##  $ VAL_LWR      : num [1:22(1d)] 2.81 2.81 2.81 2.81 2.81 ...
    ##  $ VAL_UPR      : num [1:22(1d)] 31.7 31.7 31.7 31.7 31.7 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
...
```
    ...
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num  11.6 11.6 11.6 11.6 11.6 ...
    ##  $ VAL_LWR      : num  2.81 2.81 2.81 2.81 2.81 ...
    ##  $ VAL_UPR      : num  31.7 31.7 31.7 31.7 31.7 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
|------:|----------:|----------:|----------:|
| 2,010 | 131,829.9 | 31,848.76 | 359,515.3 |
| 2,020 | 140,256.9 | 33,884.63 | 382,496.6 |

Global number of Cyclospora cases, 2010 vs 2020
...
| YEAR | VAL_MEAN |  VAL_LWR |  VAL_UPR |
|-----:|---------:|---------:|---------:|
| 2010 | 11.61685 | 2.806513 | 31.68049 |
| 2020 | 11.61685 | 2.806513 | 31.68049 |

Global incidence per 100.000 of Cyclospora cases, 2010 vs 2020
...
```
    ...
    ## TMPDIR=C:/Users/CaDi2575/AppData/Local/Temp/RtmpEtlv7o/file362c62686303 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/CaDi2575/AppData/Local/Temp/RtmpEtlv7o/file362c62686303". Did you mean command "preview"? @ C:\\PROGRA~1\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ─────────────────────────────────────────────────────────────────────────────────────────────────────────────
