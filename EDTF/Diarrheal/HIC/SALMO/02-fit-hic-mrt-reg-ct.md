Diarrheal Mortality Salmonella • Model fit
================
fbbu6966
2025-12-08
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpoJgIm2/file1e50e8e1b97 -V' had status 1
...
```
    ...
    ## -24.7873   49.5746   53.5746   55.5661   54.2805   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    0.4765  0.6903     20     no      ID 
    ## 
    ## Test for Heterogeneity:
    ## Q(df = 20) = 263.5676, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ## estimate      se      tval  df    pval    ci.lb    ci.ub      
    ##  -2.1945  0.1685  -13.0206  20  <.0001  -2.5460  -1.8429  *** 
    ## 
    ## ---
...
```
    ...
    ## 
    ##   logLik  Deviance       AIC       BIC      AICc   
    ## -24.1026   48.2053   54.2053   57.0386   55.8053   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    0.5068  0.7119     20     no      ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 19) = 225.9324, p-val < .0001
    ## 
    ## Test of Moderators (coefficient 2):
    ## F(df1 = 1, df2 = 19) = 0.0861, p-val = 0.7724
    ## 
    ## Model Results:
    ## 
    ##          estimate       se     tval  df    pval     ci.lb     ci.ub    
    ## intrcpt   11.4580  46.5484   0.2462  19  0.8082  -85.9690  108.8850    
    ## YEAR      -0.0068   0.0231  -0.2934  19  0.7724   -0.0552    0.0416    
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Full     3 54.2053 57.0386 55.8053 -24.1026               225.9324 
    ## Reduced  2 53.5746 55.5661 54.2805 -24.7873 1.3693 0.2419 263.5676
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpoJgIm2/file1e504fd37206 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpoJgIm2/file1e504fd37206". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────────────────────
