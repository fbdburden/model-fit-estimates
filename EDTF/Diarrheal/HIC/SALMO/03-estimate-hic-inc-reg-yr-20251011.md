Global incidence of Salmonella (Diarrheal) • Estimates
================
fbbu6966
2025-10-11
...
```
    ...
    ##    Data: subset(es, as.integer(FLAG) == 1) (Number of observations: 36) 
    ...
    ## sd(Intercept)     0.68      0.41     0.13     1.72 1.00     2579     2502
    ## 
    ## ~REG2:ID (Number of levels: 29) 
    ##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(Intercept)     0.72      0.11     0.54     0.97 1.00     1982     3257
    ## 
    ## Regression Coefficients:
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept   -45.58     16.25   -77.08   -13.92 1.00     5175     5679
    ## YEAR          0.03      0.01     0.01     0.04 1.00     5171     5710
    ## 
...
```
    ...
    ##  $ VAL_MEAN     : num  2496649 2579351 2665478 2755126 2847735 ...
    ##  $ VAL_LWR      : num  1790713 1858528 1932657 2003079 2079441 ...
    ##  $ VAL_UPR      : num  3451307 3551786 3649725 3750691 3876305 ...
...
```
    ...
    ## 'data.frame':    22 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num [1:22(1d)] 236 243 249 256 262 ...
    ##  $ VAL_LWR      : num [1:22(1d)] 169 175 181 186 192 ...
    ##  $ VAL_UPR      : num [1:22(1d)] 327 334 341 348 357 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
...
```
    ...
    ##  $ VAL_MEAN     : num  0 1225828 60311 855545 0 ...
    ##  $ VAL_LWR      : num  0 702053 20474 524858 0 ...
    ##  $ VAL_UPR      : num  0 1954797 143551 1328869 0 ...
...
```
    ...
    ## 'data.frame':    132 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2000 2000 2000 2000 2000 2001 2001 2001 2001 ...
    ##  $ VAL_MEAN     : num  NaN 366 245 172 NaN ...
    ##  $ VAL_LWR      : num  NaN 209.4 83.2 105.8 NaN ...
    ##  $ VAL_UPR      : num  NaN 583 583 268 NaN ...
    ##  $ LOCATION     : chr  "Region" "Region" "Region" "Region" ...
    ##  $ LOCATION_NAME: chr  "AFR" "AMR" "EMR" "EUR" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
```
    ...
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num  236 243 249 256 262 ...
    ##  $ VAL_LWR      : num  169 175 181 186 192 ...
    ##  $ VAL_UPR      : num  327 334 341 348 357 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
|------:|----------:|----------:|----------:|
| 2,010 | 3,489,318 | 2,572,272 | 4,772,398 |
| 2,020 | 4,865,666 | 3,377,385 | 6,971,138 |

Global number of Salmonella cases, 2010 vs 2020
...
Incidence per 100,000 of Salmonella by WHO region in 2020
</caption>
...
Cases of Salmonella by WHO region in 2020
</caption>
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpaGzaRO/file26545ea44ace -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpaGzaRO/file26545ea44ace". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
