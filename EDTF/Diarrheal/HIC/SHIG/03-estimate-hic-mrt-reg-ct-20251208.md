Global mortality of Shigella (Diarrheal) • Estimates
================
fbbu6966
2025-12-08
...
```
    ...
    ##  $ VAL_MEAN     : num  82.6 83.2 83.9 84.6 85.2 ...
    ##  $ VAL_LWR      : num  31.9 32.1 32.3 32.5 32.8 ...
    ##  $ VAL_UPR      : num  156 157 158 159 160 ...
...
```
    ...
    ## 'data.frame':    22 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num [1:22(1d)] 0.00782 0.00783 0.00784 0.00784 0.00785 ...
    ##  $ VAL_LWR      : num [1:22(1d)] 0.00301 0.00301 0.00302 0.00302 0.00302 ...
    ##  $ VAL_UPR      : num [1:22(1d)] 0.0147 0.0147 0.0147 0.0148 0.0148 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
...
```
    ...
    ##  $ VAL_MEAN     : num  0 41.2 1.94 25.2 0 ...
    ##  $ VAL_LWR      : num  0 10.77 0.45 5.73 0 ...
    ##  $ VAL_UPR      : num  0 89.02 5.37 66.48 0 ...
...
```
    ...
    ## 'data.frame':    132 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2000 2000 2000 2000 2000 2001 2001 2001 2001 ...
    ##  $ VAL_MEAN     : num  NaN 0.01229 0.00788 0.00508 NaN ...
    ##  $ VAL_LWR      : num  NaN 0.00321 0.00183 0.00115 NaN ...
    ##  $ VAL_UPR      : num  NaN 0.0266 0.0218 0.0134 NaN ...
    ##  $ LOCATION     : chr  "Region" "Region" "Region" "Region" ...
    ##  $ LOCATION_NAME: chr  "AFR" "AMR" "EMR" "EUR" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
```
    ...
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num  0.00782 0.00783 0.00784 0.00784 0.00785 ...
    ##  $ VAL_LWR      : num  0.00301 0.00301 0.00302 0.00302 0.00302 ...
    ##  $ VAL_UPR      : num  0.0147 0.0147 0.0147 0.0148 0.0148 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
|------:|---------:|---------:|---------:|
| 2,010 | 89.69765 | 34.52541 | 167.9251 |
| 2,020 | 96.54929 | 36.94042 | 179.8227 |

Global number of Shigella deaths, 2010 vs 2020
...
Mortality per 100,000 of Shigella by WHO region in 2020
</caption>
...
Deaths of Shigella by WHO region in 2020
</caption>
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpwhXRBk/file156470141cbc -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpwhXRBk/file156470141cbc". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────────────────────
