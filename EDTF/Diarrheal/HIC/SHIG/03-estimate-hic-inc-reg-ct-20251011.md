Global incidence of Shigella (Diarrheal) • Estimates
================
fbbu6966
2025-10-11
...
```
    ...
    ##  $ VAL_MEAN     : num  632489 637687 643035 648537 654052 ...
    ##  $ VAL_LWR      : num  363721 366649 369053 371927 374806 ...
    ##  $ VAL_UPR      : num  989021 997851 1006177 1015189 1024003 ...
...
```
    ...
    ## 'data.frame':    22 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num [1:22(1d)] 59.8 60 60.1 60.1 60.2 ...
    ##  $ VAL_LWR      : num [1:22(1d)] 34.4 34.5 34.5 34.5 34.5 ...
    ##  $ VAL_UPR      : num [1:22(1d)] 93.6 93.8 94 94.2 94.3 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
...
```
    ...
    ##  $ VAL_MEAN     : num  0 387748 12581 197228 0 ...
    ##  $ VAL_LWR      : num  0 161608 2557 100609 0 ...
    ##  $ VAL_UPR      : num  0 699528 38561 353767 0 ...
...
```
    ...
    ## 'data.frame':    132 obs. of  7 variables:
    ##  $ YEAR         : int  2000 2000 2000 2000 2000 2000 2001 2001 2001 2001 ...
    ##  $ VAL_MEAN     : num  NaN 115.7 51.1 39.7 NaN ...
    ##  $ VAL_LWR      : num  NaN 48.2 10.4 20.3 NaN ...
    ##  $ VAL_UPR      : num  NaN 208.6 156.7 71.3 NaN ...
    ##  $ LOCATION     : chr  "Region" "Region" "Region" "Region" ...
    ##  $ LOCATION_NAME: chr  "AFR" "AMR" "EMR" "EUR" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
```
    ...
    ##  $ YEAR         : int  2000 2001 2002 2003 2004 2005 2006 2007 2008 2009 ...
    ##  $ VAL_MEAN     : num  59.8 60 60.1 60.1 60.2 ...
    ##  $ VAL_LWR      : num  34.4 34.5 34.5 34.5 34.5 ...
    ##  $ VAL_UPR      : num  93.6 93.8 94 94.2 94.3 ...
    ##  $ LOCATION     : chr  "Global" "Global" "Global" "Global" ...
    ##  $ LOCATION_NAME: chr  "Global" "Global" "Global" "Global" ...
    ##  $ METRIC       : chr  "Rate" "Rate" "Rate" "Rate" ...
...
|------:|----------:|----------:|----------:|
| 2,010 | 690,189.2 | 393,843.9 | 1,082,010 |
| 2,020 | 747,007.4 | 423,660.3 | 1,179,627 |

Global number of Shigella cases, 2010 vs 2020
...
Incidence per 100.000 of Shigella by WHO region in 2020
</caption>
...
Cases of Shigella by WHO region in 2020
</caption>
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp0gRX5I/file169c70ec1473 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp0gRX5I/file169c70ec1473". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
