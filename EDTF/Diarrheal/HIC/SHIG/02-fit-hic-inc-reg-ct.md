Diarrheal Incidence Shigella • Model fit
================
fbbu6966
2025-10-11
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp0gRX5I/file169c7b447d14 -V' had status 1
...
```
    ...
    ## -31825.4858   63650.9716   63654.9716   63656.6380   63655.8287   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    1.1243  1.0603     13     no      ID 
    ## 
    ## Test for Heterogeneity:
    ## Q(df = 17) = 294860.4328, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ## estimate      se     tval  df    pval   ci.lb   ci.ub      
    ##   3.6943  0.2996  12.3310  17  <.0001  3.0622  4.3264  *** 
    ## 
    ## ---
...
```
    ...
    ## 
    ##      logLik     Deviance          AIC          BIC         AICc   
    ## -31823.4209   63646.8417   63652.8417   63655.1595   63654.8417   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed  factor 
    ## sigma^2    0.9850  0.9924     13     no      ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 16) = 287261.2537, p-val < .0001
    ## 
    ## Test of Moderators (coefficient 2):
    ## F(df1 = 1, df2 = 16) = 2.2953, p-val = 0.1493
    ## 
    ## Model Results:
    ## 
    ##          estimate       se     tval  df    pval     ci.lb     ci.ub    
    ## intrcpt  135.5117  87.0058   1.5575  16  0.1389  -48.9324  319.9557    
    ## YEAR      -0.0657   0.0434  -1.5150  16  0.1493   -0.1577    0.0262    
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Full     3 63652.8417 63655.1595 63654.8417 -31823.4209               287261.2537 
    ## Reduced  2 63654.9716 63656.6380 63655.8287 -31825.4858 4.1299 0.0421 294860.4328
...
```
    ...
    ## Warning: There were 27 divergent transitions after warmup. Increasing adapt_delta above 0.9 may help. See
    ## http://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup

    ##  Family: gaussian 
    ##   Links: mu = identity; sigma = identity 
    ## Formula: yi | se(sei) ~ 1 + (1 | REG2) + (1 | REG2:ID) 
    ##    Data: subset(es, as.integer(FLAG) == 1) (Number of observations: 18) 
    ...
    ## sd(Intercept)     1.07      0.45     0.38     2.12 1.00     4409     3549
    ## 
    ## ~REG2:ID (Number of levels: 13) 
    ##               Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sd(Intercept)     0.67      0.18     0.42     1.12 1.00     2961     3959
    ## 
    ## Regression Coefficients:
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept     3.70      0.66     2.34     5.05 1.00     5152     4955
    ## 
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp0gRX5I/file169c13dd7350 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp0gRX5I/file169c13dd7350". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
