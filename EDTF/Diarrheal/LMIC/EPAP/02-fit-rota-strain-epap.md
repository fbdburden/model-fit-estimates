...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpiQ4i6B/file38548dd7ad5 -V' had status 1
...
es$STRAIN <- relevel(es$STRAIN, "Atypical")
print(table(es$STRAIN))
```

    ## 
    ##         Atypical Undifferentiated 
    ##              249              237
...
```
    ...
    ## 
    ## Multivariate Meta-Analysis Model (k = 417; method: REML)
    ## 
    ##    logLik   Deviance        AIC        BIC       AICc   
    ## -858.3665  1716.7329  1740.7329  1788.8975  1741.5208   
    ## 
    ## Variance Components:
    ## 
    ...
    ## sigma^2.3  0.0862  0.2937     41     no     REG2/SUB2/COUNTRY 
    ## sigma^2.4  1.2181  1.1037    121     no  REG2/SUB2/COUNTRY/ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 409) = 11485.3063, p-val < .0001
    ## 
    ## Test of Moderators (coefficients 2:8):
    ## F(df1 = 7, df2 = 409) = 16.7651, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                         estimate      se      tval   df    pval    ci.lb    ci.ub      
    ## intrcpt                  -2.5745  0.1767  -14.5739  409  <.0001  -2.9218  -2.2273  *** 
    ## SYNDROMTYPEInpatient     -0.2006  0.0503   -3.9911  409  <.0001  -0.2994  -0.1018  *** 
    ## SYNDROMTYPEOutpatient    -0.2064  0.0246   -8.3932  409  <.0001  -0.2548  -0.1581  *** 
    ## AGEAge below 5            0.2128  0.0418    5.0877  409  <.0001   0.1306   0.2950  *** 
    ## AGEMixed ages             0.2578  0.0724    3.5624  409  0.0004   0.1156   0.4001  *** 
    ## REFERENCEOther           -0.1840  0.3397   -0.5416  409  0.5884  -0.8517   0.4838      
    ## COVERAGE                  0.0059  0.0025    2.3660  409  0.0184   0.0010   0.0109    * 
    ## STRAINUndifferentiated    0.1043  0.2269    0.4598  409  0.6459  -0.3418   0.5505      
    ## 
    ## ---
...
```
    ...
    ## 
    ##    logLik   Deviance        AIC        BIC       AICc   
    ## -851.6039  1703.2078  1729.2078  1781.3543  1730.1317   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed                factor 
    ...
    ## sigma^2.2  0.0000  0.0009     12     no             REG2/SUB2 
    ## sigma^2.3  0.1446  0.3803     41     no     REG2/SUB2/COUNTRY 
    ## sigma^2.4  1.0691  1.0340    121     no  REG2/SUB2/COUNTRY/ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 408) = 11081.1997, p-val < .0001
    ## 
    ## Test of Moderators (coefficients 2:9):
    ## F(df1 = 8, df2 = 408) = 16.0893, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                          estimate       se     tval   df    pval      ci.lb     ci.ub      
    ## intrcpt                 -140.5722  40.8651  -3.4399  408  0.0006  -220.9045  -60.2399  *** 
    ## YEAR                       0.0687   0.0203   3.3779  408  0.0008     0.0287    0.1087  *** 
    ## SYNDROMTYPEInpatient      -0.2032   0.0502  -4.0474  408  <.0001    -0.3019   -0.1045  *** 
    ## SYNDROMTYPEOutpatient     -0.2063   0.0246  -8.3910  408  <.0001    -0.2546   -0.1580  *** 
    ## AGEAge below 5             0.2111   0.0418   5.0510  408  <.0001     0.1290    0.2933  *** 
    ## AGEMixed ages              0.2536   0.0723   3.5079  408  0.0005     0.1115    0.3957  *** 
    ## REFERENCEOther             0.2958   0.3540   0.8355  408  0.4039    -0.4001    0.9916      
    ## COVERAGE                   0.0018   0.0027   0.6388  408  0.5233    -0.0036    0.0071      
    ## STRAINUndifferentiated     0.0140   0.2205   0.0636  408  0.9493    -0.4194    0.4474      
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Full    13 1729.2078 1781.3543 1730.1317 -851.6039                11081.1997 
    ## Reduced 12 1740.7329 1788.8975 1741.5208 -858.3665 13.5251 0.0002 11485.3063
...
``` r
setwd(params$Dir)
image <- paste0("02-fit-rota-strain-epap_files/figure-gfm/r_lineartimetrend.png")
cat("![](",image,")")
```

![](02-fit-rota-strain-epap_files/figure-gfm/r_lineartimetrend.png)
...
``` r
setwd(params$Dir)
image <- paste0("02-fit-rota-strain-epap_files/figure-gfm/r_nonlineartimetrend.png")
cat("![](",image,")")
```

![](02-fit-rota-strain-epap_files/figure-gfm/r_nonlineartimetrend.png)
...
setwd(params$Dir)
for (i in 1:length){
  image <- paste0("02-fit-rota-strain-epap_files/figure-gfm/r_summary-",i,".png")
  cat("![](",image,")")
}
```

![](02-fit-rota-strain-epap_files/figure-gfm/r_summary-1.png)![](02-fit-rota-strain-epap_files/figure-gfm/r_summary-2.png)![](02-fit-rota-strain-epap_files/figure-gfm/r_summary-3.png)![](02-fit-rota-strain-epap_files/figure-gfm/r_summary-4.png)![](02-fit-rota-strain-epap_files/figure-gfm/r_summary-5.png)![](02-fit-rota-strain-epap_files/figure-gfm/r_summary-6.png)![](02-fit-rota-strain-epap_files/figure-gfm/r_summary-7.png)![](02-fit-rota-strain-epap_files/figure-gfm/r_summary-8.png)![](02-fit-rota-strain-epap_files/figure-gfm/r_summary-9.png)![](02-fit-rota-strain-epap_files/figure-gfm/r_summary-10.png)![](02-fit-rota-strain-epap_files/figure-gfm/r_summary-11.png)![](02-fit-rota-strain-epap_files/figure-gfm/r_summary-12.png)![](02-fit-rota-strain-epap_files/figure-gfm/r_summary-13.png)![](02-fit-rota-strain-epap_files/figure-gfm/r_summary-14.png)![](02-fit-rota-strain-epap_files/figure-gfm/r_summary-15.png)

``` r
P <- plot(conditional_effects(fit_brms_reg_s), points = TRUE, ask=FALSE)
```

![](02-fit-rota-strain-epap_files/figure-gfm/r_conditional_effects-1.png)<!-- -->![](02-fit-rota-strain-epap_files/figure-gfm/r_conditional_effects-2.png)<!-- -->![](02-fit-rota-strain-epap_files/figure-gfm/r_conditional_effects-3.png)<!-- -->![](02-fit-rota-strain-epap_files/figure-gfm/r_conditional_effects-4.png)<!-- -->![](02-fit-rota-strain-epap_files/figure-gfm/r_conditional_effects-5.png)<!-- -->![](02-fit-rota-strain-epap_files/figure-gfm/r_conditional_effects-6.png)<!-- -->
...
# setwd(params$Dir)
for (i in 1:length){
  image <- paste0("02-fit-rota-strain-epap_files/figure-gfm/r_conditional_effects-",i,".png")
  cat("![](",image,")")
}
```
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpiQ4i6B/file385455ff6bf1 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpiQ4i6B/file385455ff6bf1". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
