...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmpo5V3JA/file49902a54729c -V' had status 1
...
es$STRAIN <- relevel(es$STRAIN, "LT")
...
```
    ...
    ## 
    ## Multivariate Meta-Analysis Model (k = 453; method: REML)
    ## 
    ##    logLik   Deviance        AIC        BIC       AICc   
    ## -982.9050  1965.8100  1989.8100  2038.9869  1990.5322   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed                factor 
    ## sigma^2.1  0.2806  0.5297      6     no                  REG2 
    ## sigma^2.2  0.0000  0.0009     12     no             REG2/SUB2 
    ## sigma^2.3  0.0742  0.2723     45     no     REG2/SUB2/COUNTRY 
    ## sigma^2.4  1.2953  1.1381    129     no  REG2/SUB2/COUNTRY/ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 445) = 17885.9817, p-val < .0001
    ## 
    ## Test of Moderators (coefficients 2:8):
    ## F(df1 = 7, df2 = 445) = 17.8960, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                         estimate      se     tval   df    pval    ci.lb    ci.ub      
    ## intrcpt                  -2.2081  0.2956  -7.4694  445  <.0001  -2.7891  -1.6271  *** 
    ## SYNDROMTYPEInpatient     -0.0706  0.0500  -1.4114  445  0.1588  -0.1689   0.0277      
    ## SYNDROMTYPEOutpatient     0.1549  0.0225   6.8932  445  <.0001   0.1107   0.1990  *** 
    ## AGEAge below 5           -0.2362  0.0304  -7.7797  445  <.0001  -0.2959  -0.1766  *** 
    ## AGEMixed ages            -0.2299  0.0509  -4.5137  445  <.0001  -0.3299  -0.1298  *** 
    ## REFERENCEOther            0.2094  0.3385   0.6185  445  0.5366  -0.4559   0.8747      
    ## COVERAGE                  0.0002  0.0038   0.0587  445  0.9532  -0.0072   0.0077      
    ## STRAINUndifferentiated   -0.4864  0.2224  -2.1870  445  0.0293  -0.9235  -0.0493    * 
    ## 
    ## ---
...
```
    ...
    ## 
    ##    logLik   Deviance        AIC        BIC       AICc   
    ## -981.2365  1962.4731  1988.4731  2041.7188  1989.3196   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed                factor 
    ## sigma^2.1  0.2776  0.5269      6     no                  REG2 
    ## sigma^2.2  0.0000  0.0009     12     no             REG2/SUB2 
    ## sigma^2.3  0.0746  0.2731     45     no     REG2/SUB2/COUNTRY 
    ## sigma^2.4  1.3033  1.1416    129     no  REG2/SUB2/COUNTRY/ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 444) = 17722.7236, p-val < .0001
    ## 
    ## Test of Moderators (coefficients 2:9):
    ## F(df1 = 8, df2 = 444) = 15.6674, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                         estimate       se     tval   df    pval     ci.lb    ci.ub      
    ## intrcpt                 -13.1388  42.1672  -0.3116  444  0.7555  -96.0108  69.7333      
    ## YEAR                      0.0054   0.0210   0.2592  444  0.7956   -0.0358   0.0467      
    ## SYNDROMTYPEInpatient     -0.0707   0.0500  -1.4143  444  0.1580   -0.1690   0.0276      
    ## SYNDROMTYPEOutpatient     0.1549   0.0225   6.8946  444  <.0001    0.1108   0.1991  *** 
    ## AGEAge below 5           -0.2363   0.0304  -7.7827  444  <.0001   -0.2960  -0.1767  *** 
    ## AGEMixed ages            -0.2299   0.0509  -4.5143  444  <.0001   -0.3300  -0.1298  *** 
    ## REFERENCEOther            0.2389   0.3576   0.6682  444  0.5044   -0.4638   0.9417      
    ## COVERAGE                 -0.0001   0.0040  -0.0317  444  0.9747   -0.0081   0.0078      
    ## STRAINUndifferentiated   -0.4863   0.2231  -2.1804  444  0.0297   -0.9247  -0.0480    * 
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Full    13 1988.4731 2041.7188 1989.3196 -981.2365               17722.7236 
    ## Reduced 12 1989.8100 2038.9869 1990.5322 -982.9050 3.3369 0.0677 17885.9817
...
``` r
setwd(params$Dir)
image <- paste0("02-fit-rota-strain-etlt_files/figure-gfm/r_lineartimetrend.png")
cat("![](",image,")")
```

![](02-fit-rota-strain-etlt_files/figure-gfm/r_lineartimetrend.png)
...
``` r
setwd(params$Dir)
image <- paste0("02-fit-rota-strain-etlt_files/figure-gfm/r_nonlineartimetrend.png")
cat("![](",image,")")
```

![](02-fit-rota-strain-etlt_files/figure-gfm/r_nonlineartimetrend.png)
...
setwd(params$Dir)
for (i in 1:length){
  image <- paste0("02-fit-rota-strain-etlt_files/figure-gfm/r_summary-",i,".png")
  cat("![](",image,")")
}
```

![](02-fit-rota-strain-etlt_files/figure-gfm/r_summary-1.png)![](02-fit-rota-strain-etlt_files/figure-gfm/r_summary-2.png)![](02-fit-rota-strain-etlt_files/figure-gfm/r_summary-3.png)![](02-fit-rota-strain-etlt_files/figure-gfm/r_summary-4.png)![](02-fit-rota-strain-etlt_files/figure-gfm/r_summary-5.png)![](02-fit-rota-strain-etlt_files/figure-gfm/r_summary-6.png)![](02-fit-rota-strain-etlt_files/figure-gfm/r_summary-7.png)![](02-fit-rota-strain-etlt_files/figure-gfm/r_summary-8.png)![](02-fit-rota-strain-etlt_files/figure-gfm/r_summary-9.png)![](02-fit-rota-strain-etlt_files/figure-gfm/r_summary-10.png)![](02-fit-rota-strain-etlt_files/figure-gfm/r_summary-11.png)![](02-fit-rota-strain-etlt_files/figure-gfm/r_summary-12.png)![](02-fit-rota-strain-etlt_files/figure-gfm/r_summary-13.png)![](02-fit-rota-strain-etlt_files/figure-gfm/r_summary-14.png)![](02-fit-rota-strain-etlt_files/figure-gfm/r_summary-15.png)

``` r
P <- plot(conditional_effects(fit_brms_reg_s), points = TRUE, ask=FALSE)
```

![](02-fit-rota-strain-etlt_files/figure-gfm/r_conditional_effects-1.png)<!-- -->![](02-fit-rota-strain-etlt_files/figure-gfm/r_conditional_effects-2.png)<!-- -->![](02-fit-rota-strain-etlt_files/figure-gfm/r_conditional_effects-3.png)<!-- -->![](02-fit-rota-strain-etlt_files/figure-gfm/r_conditional_effects-4.png)<!-- -->![](02-fit-rota-strain-etlt_files/figure-gfm/r_conditional_effects-5.png)<!-- -->![](02-fit-rota-strain-etlt_files/figure-gfm/r_conditional_effects-6.png)<!-- -->
...
# setwd(params$Dir)
for (i in 1:length){
  image <- paste0("02-fit-rota-strain-etlt_files/figure-gfm/r_conditional_effects-",i,".png")
  cat("![](",image,")")
}
```
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmpo5V3JA/file4990707ae76 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmpo5V3JA/file4990707ae76". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
