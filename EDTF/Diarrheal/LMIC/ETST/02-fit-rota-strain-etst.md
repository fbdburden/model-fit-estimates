...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpSICaYw/file45f8359c375f -V' had status 1
...
es$STRAIN <- relevel(es$STRAIN, "ST")
...
```
    ...
    ## 
    ## Multivariate Meta-Analysis Model (k = 446; method: REML)
    ## 
    ##     logLik    Deviance         AIC         BIC        AICc   
    ## -1129.9434   2259.8867   2283.8867   2332.8734   2284.6209   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed                factor 
    ## sigma^2.1  0.2808  0.5299      6     no                  REG2 
    ## sigma^2.2  0.0000  0.0008     12     no             REG2/SUB2 
    ## sigma^2.3  0.1297  0.3601     45     no     REG2/SUB2/COUNTRY 
    ## sigma^2.4  1.1630  1.0784    127     no  REG2/SUB2/COUNTRY/ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 438) = 16454.9962, p-val < .0001
    ## 
    ## Test of Moderators (coefficients 2:8):
    ## F(df1 = 7, df2 = 438) = 55.9014, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                         estimate      se     tval   df    pval    ci.lb    ci.ub      
    ## intrcpt                  -2.8210  0.2952  -9.5564  438  <.0001  -3.4011  -2.2408  *** 
    ## SYNDROMTYPEInpatient      0.1598  0.0510   3.1347  438  0.0018   0.0596   0.2600   ** 
    ## SYNDROMTYPEOutpatient     0.4610  0.0260  17.7289  438  <.0001   0.4099   0.5122  *** 
    ## AGEAge below 5           -0.2314  0.0289  -7.9991  438  <.0001  -0.2883  -0.1746  *** 
    ## AGEMixed ages            -0.2314  0.0512  -4.5184  438  <.0001  -0.3320  -0.1307  *** 
    ## REFERENCEOther            0.2272  0.3341   0.6802  438  0.4968  -0.4293   0.8838      
    ## COVERAGE                  0.0007  0.0037   0.1831  438  0.8548  -0.0066   0.0080      
    ## STRAINUndifferentiated   -0.1204  0.2078  -0.5795  438  0.5625  -0.5288   0.2880      
    ## 
    ## ---
...
```
    ...
    ## 
    ##     logLik    Deviance         AIC         BIC        AICc   
    ## -1128.1427   2256.2854   2282.2854   2335.3245   2283.1459   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed                factor 
    ## sigma^2.1  0.2942  0.5424      6     no                  REG2 
    ## sigma^2.2  0.0000  0.0009     12     no             REG2/SUB2 
    ## sigma^2.3  0.1511  0.3887     45     no     REG2/SUB2/COUNTRY 
    ## sigma^2.4  1.1833  1.0878    127     no  REG2/SUB2/COUNTRY/ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 437) = 16451.5964, p-val < .0001
    ## 
    ## Test of Moderators (coefficients 2:9):
    ## F(df1 = 8, df2 = 437) = 48.9853, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                         estimate       se     tval   df    pval     ci.lb     ci.ub      
    ## intrcpt                  25.9800  44.0783   0.5894  437  0.5559  -60.6518  112.6117      
    ## YEAR                     -0.0143   0.0219  -0.6533  437  0.5139   -0.0574    0.0288      
    ## SYNDROMTYPEInpatient      0.1606   0.0510   3.1494  437  0.0017    0.0604    0.2609   ** 
    ## SYNDROMTYPEOutpatient     0.4611   0.0260  17.7293  437  <.0001    0.4100    0.5122  *** 
    ## AGEAge below 5           -0.2313   0.0289  -7.9913  437  <.0001   -0.2882   -0.1744  *** 
    ## AGEMixed ages            -0.2308   0.0512  -4.5059  437  <.0001   -0.3314   -0.1301  *** 
    ## REFERENCEOther            0.1561   0.3547   0.4401  437  0.6601   -0.5410    0.8532      
    ## COVERAGE                  0.0015   0.0040   0.3744  437  0.7083   -0.0064    0.0094      
    ## STRAINUndifferentiated   -0.1246   0.2103  -0.5926  437  0.5537   -0.5379    0.2887      
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Full    13 2282.2854 2335.3245 2283.1459 -1128.1427               16451.5964 
    ## Reduced 12 2283.8867 2332.8734 2284.6209 -1129.9434 3.6014 0.0577 16454.9962
...
``` r
setwd(params$Dir)
image <- paste0("02-fit-rota-strain-etst_files/figure-gfm/r_lineartimetrend.png")
cat("![](",image,")")
```

![](02-fit-rota-strain-etst_files/figure-gfm/r_lineartimetrend.png)
...
``` r
setwd(params$Dir)
image <- paste0("02-fit-rota-strain-etst_files/figure-gfm/r_nonlineartimetrend.png")
cat("![](",image,")")
```

![](02-fit-rota-strain-etst_files/figure-gfm/r_nonlineartimetrend.png)
...
setwd(params$Dir)
for (i in 1:length){
  image <- paste0("02-fit-rota-strain-etst_files/figure-gfm/r_summary-",i,".png")
  cat("![](",image,")")
}
```

![](02-fit-rota-strain-etst_files/figure-gfm/r_summary-1.png)![](02-fit-rota-strain-etst_files/figure-gfm/r_summary-2.png)![](02-fit-rota-strain-etst_files/figure-gfm/r_summary-3.png)![](02-fit-rota-strain-etst_files/figure-gfm/r_summary-4.png)![](02-fit-rota-strain-etst_files/figure-gfm/r_summary-5.png)![](02-fit-rota-strain-etst_files/figure-gfm/r_summary-6.png)![](02-fit-rota-strain-etst_files/figure-gfm/r_summary-7.png)![](02-fit-rota-strain-etst_files/figure-gfm/r_summary-8.png)![](02-fit-rota-strain-etst_files/figure-gfm/r_summary-9.png)![](02-fit-rota-strain-etst_files/figure-gfm/r_summary-10.png)![](02-fit-rota-strain-etst_files/figure-gfm/r_summary-11.png)![](02-fit-rota-strain-etst_files/figure-gfm/r_summary-12.png)![](02-fit-rota-strain-etst_files/figure-gfm/r_summary-13.png)![](02-fit-rota-strain-etst_files/figure-gfm/r_summary-14.png)![](02-fit-rota-strain-etst_files/figure-gfm/r_summary-15.png)

``` r
P <- plot(conditional_effects(fit_brms_reg_s), points = TRUE, ask=FALSE)
```

![](02-fit-rota-strain-etst_files/figure-gfm/r_conditional_effects-1.png)<!-- -->![](02-fit-rota-strain-etst_files/figure-gfm/r_conditional_effects-2.png)<!-- -->![](02-fit-rota-strain-etst_files/figure-gfm/r_conditional_effects-3.png)<!-- -->![](02-fit-rota-strain-etst_files/figure-gfm/r_conditional_effects-4.png)<!-- -->![](02-fit-rota-strain-etst_files/figure-gfm/r_conditional_effects-5.png)<!-- -->![](02-fit-rota-strain-etst_files/figure-gfm/r_conditional_effects-6.png)<!-- -->
...
# setwd(params$Dir)
for (i in 1:length){
  image <- paste0("02-fit-rota-strain-etst_files/figure-gfm/r_conditional_effects-",i,".png")
  cat("![](",image,")")
}
```
...
```
    ...
    ##   r_4_1 = (sd_4[1] * (z_4[1]));
    ##   r_5_1 = (sd_5[1] * (z_5[1]));
    ##   lprior += student_t_lpdf(Intercept | 3, -2.5, 2.5);
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpSICaYw/file45f82e0729f8 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpSICaYw/file45f82e0729f8". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
