...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmpw7lR3N/file4a8454d41a65 -V' had status 1
...
```
    ...
    ## -1059.4891   2118.9782   2140.9782   2184.6621   2141.6729   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed                factor 
    ## sigma^2.1  0.0988  0.3144      6     no                  REG2 
    ## sigma^2.2  0.0000  0.0017     12     no             REG2/SUB2 
    ## sigma^2.3  0.1799  0.4241     36     no     REG2/SUB2/COUNTRY 
    ## sigma^2.4  1.6126  1.2699    102     no  REG2/SUB2/COUNTRY/ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 392) = 17348.3148, p-val < .0001
    ## 
    ## Test of Moderators (coefficients 2:7):
    ## F(df1 = 6, df2 = 392) = 7.3675, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                        estimate      se     tval   df    pval    ci.lb    ci.ub      
    ## intrcpt                 -1.9463  0.2339  -8.3197  392  <.0001  -2.4062  -1.4864  *** 
    ## SYNDROMTYPEInpatient     0.0237  0.0442   0.5366  392  0.5918  -0.0632   0.1107      
    ## SYNDROMTYPEOutpatient    0.0094  0.0195   0.4807  392  0.6310  -0.0290   0.0477      
    ## AGEAge below 5           0.2120  0.0426   4.9739  392  <.0001   0.1282   0.2958  *** 
    ## AGEMixed ages            0.1029  0.0723   1.4236  392  0.1554  -0.0392   0.2451      
    ## REFERENCEOther          -0.6980  0.3298  -2.1165  392  0.0349  -1.3463  -0.0496    * 
    ## COVERAGE                 0.0099  0.0027   3.6428  392  0.0003   0.0045   0.0152  *** 
    ## 
    ## ---
...
```
    ...
    ## 
    ##     logLik    Deviance         AIC         BIC        AICc   
    ## -1054.2509   2108.5017   2132.5017   2180.1262   2133.3271   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed                factor 
    ## sigma^2.1  0.0000  0.0044      6     no                  REG2 
    ## sigma^2.2  0.0000  0.0014     12     no             REG2/SUB2 
    ## sigma^2.3  0.3984  0.6312     36     no     REG2/SUB2/COUNTRY 
    ## sigma^2.4  1.3994  1.1829    102     no  REG2/SUB2/COUNTRY/ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 391) = 17347.4605, p-val < .0001
    ## 
    ## Test of Moderators (coefficients 2:8):
    ## F(df1 = 7, df2 = 391) = 7.5607, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                         estimate       se     tval   df    pval      ci.lb     ci.ub      
    ## intrcpt                -165.6127  57.3784  -2.8863  391  0.0041  -278.4216  -52.8039   ** 
    ## YEAR                      0.0815   0.0286   2.8543  391  0.0045     0.0254    0.1376   ** 
    ## SYNDROMTYPEInpatient      0.0259   0.0442   0.5852  391  0.5588    -0.0610    0.1128      
    ## SYNDROMTYPEOutpatient     0.0092   0.0195   0.4696  391  0.6389    -0.0292    0.0475      
    ## AGEAge below 5            0.2125   0.0426   4.9874  391  <.0001     0.1287    0.2962  *** 
    ## AGEMixed ages             0.1038   0.0723   1.4364  391  0.1517    -0.0383    0.2459      
    ## REFERENCEOther           -0.4361   0.3276  -1.3312  391  0.1839    -1.0801    0.2080      
    ## COVERAGE                  0.0049   0.0032   1.5254  391  0.1280    -0.0014    0.0111      
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Full    12 2132.5017 2180.1262 2133.3271 -1054.2509                17347.4605 
    ## Reduced 11 2140.9782 2184.6621 2141.6729 -1059.4891 10.4764 0.0012 17348.3148
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmpw7lR3N/file4a844f901d6e -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmpw7lR3N/file4a844f901d6e". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
