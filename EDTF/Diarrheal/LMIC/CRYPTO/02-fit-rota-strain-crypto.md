Diarrheal Cryptosporidium • Models fit
================
fbbu6966
2025-11-27
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpovsgW9/file231c15b54714 -V' had status 1
...
es$STRAIN <- relevel(es$STRAIN, "Undifferentiated")
print(table(es$STRAIN))
```

    ## 
    ## Undifferentiated           parvum 
    ##              485               14
...
```
    ...
    ## 
    ## Multivariate Meta-Analysis Model (k = 426; method: REML)
    ## 
    ##    logLik   Deviance        AIC        BIC       AICc   
    ## -954.1221  1908.2441  1932.2441  1980.6699  1933.0145   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed                factor 
    ## sigma^2.1  0.5144  0.7172      6     no                  REG2 
    ## sigma^2.2  0.0000  0.0023     11     no             REG2/SUB2 
    ## sigma^2.3  0.2168  0.4656     40     no     REG2/SUB2/COUNTRY 
    ## sigma^2.4  0.5338  0.7306    100     no  REG2/SUB2/COUNTRY/ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 418) = 6463.1235, p-val < .0001
    ## 
    ## Test of Moderators (coefficients 2:8):
    ## F(df1 = 7, df2 = 418) = 38.8972, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                        estimate      se     tval   df    pval    ci.lb    ci.ub      
    ## intrcpt                 -3.3928  0.3564  -9.5208  418  <.0001  -4.0932  -2.6923  *** 
    ## SYNDROMTYPEInpatient     0.6662  0.0616  10.8068  418  <.0001   0.5450   0.7873  *** 
    ## SYNDROMTYPEOutpatient    0.3312  0.0262  12.6460  418  <.0001   0.2798   0.3827  *** 
    ## AGEAge below 5           0.3390  0.1084   3.1265  418  0.0019   0.1259   0.5522   ** 
    ## AGEMixed ages            0.2135  0.1930   1.1060  418  0.2694  -0.1659   0.5929      
    ## REFERENCEOther          -0.7452  0.1781  -4.1845  418  <.0001  -1.0952  -0.3951  *** 
    ## COVERAGE                -0.0004  0.0026  -0.1497  418  0.8811  -0.0055   0.0048      
    ## STRAINparvum            -0.5000  0.3961  -1.2621  418  0.2076  -1.2787   0.2787      
    ## 
    ## ---
...
```
    ...
    ## 
    ##    logLik   Deviance        AIC        BIC       AICc   
    ## -952.4648  1904.9296  1930.9296  1983.3597  1931.8328   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed                factor 
    ## sigma^2.1  0.5016  0.7082      6     no                  REG2 
    ## sigma^2.2  0.0000  0.0025     11     no             REG2/SUB2 
    ## sigma^2.3  0.2217  0.4708     40     no     REG2/SUB2/COUNTRY 
    ## sigma^2.4  0.5364  0.7324    100     no  REG2/SUB2/COUNTRY/ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 417) = 6455.7586, p-val < .0001
    ## 
    ## Test of Moderators (coefficients 2:9):
    ## F(df1 = 8, df2 = 417) = 34.1140, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                        estimate       se     tval   df    pval     ci.lb    ci.ub      
    ## intrcpt                 24.7378  34.3848   0.7194  417  0.4723  -42.8514  92.3269      
    ## YEAR                    -0.0140   0.0171  -0.8181  417  0.4138   -0.0476   0.0196      
    ## SYNDROMTYPEInpatient     0.6659   0.0617  10.7998  417  <.0001    0.5447   0.7870  *** 
    ## SYNDROMTYPEOutpatient    0.3312   0.0262  12.6461  417  <.0001    0.2798   0.3827  *** 
    ## AGEAge below 5           0.3333   0.1087   3.0669  417  0.0023    0.1197   0.5470   ** 
    ## AGEMixed ages            0.2165   0.1932   1.1206  417  0.2631   -0.1633   0.5962      
    ## REFERENCEOther          -0.8116   0.1957  -4.1470  417  <.0001   -1.1963  -0.4269  *** 
    ## COVERAGE                 0.0005   0.0028   0.1813  417  0.8562   -0.0051   0.0061      
    ## STRAINparvum            -0.5566   0.4031  -1.3808  417  0.1681   -1.3489   0.2357      
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Full    13 1930.9296 1983.3597 1931.8328 -952.4648               6455.7586 
    ## Reduced 12 1932.2441 1980.6699 1933.0145 -954.1221 3.3146 0.0687 6463.1235
...
``` r
setwd(params$Dir)
image <- paste0("02-fit-rota-strain-crypto_files/figure-gfm/r_lineartimetrend.png")
cat("![](",image,")")
```

![](02-fit-rota-strain-crypto_files/figure-gfm/r_lineartimetrend.png)
...
``` r
setwd(params$Dir)
image <- paste0("02-fit-rota-strain-crypto_files/figure-gfm/r_nonlineartimetrend.png")
cat("![](",image,")")
```

![](02-fit-rota-strain-crypto_files/figure-gfm/r_nonlineartimetrend.png)
...
setwd(params$Dir)
for (i in 1:length){
  image <- paste0("02-fit-rota-strain-crypto_files/figure-gfm/r_summary-",i,".png")
  cat("![](",image,")")
}
```

![](02-fit-rota-strain-crypto_files/figure-gfm/r_summary-1.png)![](02-fit-rota-strain-crypto_files/figure-gfm/r_summary-2.png)![](02-fit-rota-strain-crypto_files/figure-gfm/r_summary-3.png)![](02-fit-rota-strain-crypto_files/figure-gfm/r_summary-4.png)![](02-fit-rota-strain-crypto_files/figure-gfm/r_summary-5.png)![](02-fit-rota-strain-crypto_files/figure-gfm/r_summary-6.png)![](02-fit-rota-strain-crypto_files/figure-gfm/r_summary-7.png)![](02-fit-rota-strain-crypto_files/figure-gfm/r_summary-8.png)![](02-fit-rota-strain-crypto_files/figure-gfm/r_summary-9.png)![](02-fit-rota-strain-crypto_files/figure-gfm/r_summary-10.png)![](02-fit-rota-strain-crypto_files/figure-gfm/r_summary-11.png)![](02-fit-rota-strain-crypto_files/figure-gfm/r_summary-12.png)![](02-fit-rota-strain-crypto_files/figure-gfm/r_summary-13.png)![](02-fit-rota-strain-crypto_files/figure-gfm/r_summary-14.png)![](02-fit-rota-strain-crypto_files/figure-gfm/r_summary-15.png)

``` r
P <- plot(conditional_effects(fit_brms_reg_s), points = TRUE, ask=FALSE)
```

![](02-fit-rota-strain-crypto_files/figure-gfm/r_conditional_effects-1.png)<!-- -->![](02-fit-rota-strain-crypto_files/figure-gfm/r_conditional_effects-2.png)<!-- -->![](02-fit-rota-strain-crypto_files/figure-gfm/r_conditional_effects-3.png)<!-- -->![](02-fit-rota-strain-crypto_files/figure-gfm/r_conditional_effects-4.png)<!-- -->![](02-fit-rota-strain-crypto_files/figure-gfm/r_conditional_effects-5.png)<!-- -->![](02-fit-rota-strain-crypto_files/figure-gfm/r_conditional_effects-6.png)<!-- -->
...
# setwd(params$Dir)
for (i in 1:length){
  image <- paste0("02-fit-rota-strain-crypto_files/figure-gfm/r_conditional_effects-",i,".png")
  cat("![](",image,")")
}
```
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpovsgW9/file231c2554ae6 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpovsgW9/file231c2554ae6". Did you mean command "remove"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ─────────────────────────────────────────────────────────────────────────────────────────────────────────────
