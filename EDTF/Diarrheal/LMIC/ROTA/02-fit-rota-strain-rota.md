Diarrheal Rotavirus • Models fit
================
fbbu6966
2025-09-28
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpOgtm2C/file37e815d36e3c -V' had status 1
...
```
    ...
    ## -2175.5558   4351.1117   4375.1117   4427.4887   4375.6609   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed                factor 
    ## sigma^2.1  0.0000  0.0000      6     no                  REG2 
    ## sigma^2.2  0.0000  0.0000     12     no             REG2/SUB2 
    ## sigma^2.3  0.0000  0.0018     53     no     REG2/SUB2/COUNTRY 
    ## sigma^2.4  0.6495  0.8059    177     no  REG2/SUB2/COUNTRY/ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 581) = 15207.3252, p-val < .0001
    ## 
    ## Test of Moderators (coefficients 2:8):
    ## F(df1 = 7, df2 = 581) = 1268.7081, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                        estimate      se      tval   df    pval    ci.lb    ci.ub      
    ## intrcpt                 -4.4430  0.1024  -43.3784  581  <.0001  -4.6442  -4.2418  *** 
    ## SYNDROMTYPEInpatient     2.2065  0.0440   50.1630  581  <.0001   2.1201   2.2929  *** 
    ## SYNDROMTYPEOutpatient    1.3435  0.0294   45.6374  581  <.0001   1.2857   1.4013  *** 
    ## AGEAge below 5           1.8475  0.0249   74.2543  581  <.0001   1.7987   1.8964  *** 
    ## AGEMixed ages            1.1912  0.0373   31.9688  581  <.0001   1.1180   1.2643  *** 
    ## REFERENCEOther          -0.3510  0.1257   -2.7914  581  0.0054  -0.5979  -0.1040   ** 
    ## COVERAGE                -0.0056  0.0013   -4.3089  581  <.0001  -0.0082  -0.0031  *** 
    ## STRAINGroup_A            0.2279  0.1539    1.4805  581  0.1393  -0.0744   0.5302      
    ## 
    ## ---
...
```
    ...
    ## 
    ##     logLik    Deviance         AIC         BIC        AICc   
    ## -2173.0844   4346.1688   4372.1688   4428.8882   4372.8119   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed                factor 
    ## sigma^2.1  0.0000  0.0020      6     no                  REG2 
    ## sigma^2.2  0.0000  0.0038     12     no             REG2/SUB2 
    ## sigma^2.3  0.0011  0.0332     53     no     REG2/SUB2/COUNTRY 
    ## sigma^2.4  0.6746  0.8213    177     no  REG2/SUB2/COUNTRY/ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 580) = 15037.3242, p-val < .0001
    ## 
    ## Test of Moderators (coefficients 2:9):
    ## F(df1 = 8, df2 = 580) = 1110.1283, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                        estimate       se     tval   df    pval     ci.lb    ci.ub      
    ## intrcpt                 33.6941  23.1921   1.4528  580  0.1468  -11.8566  79.2448      
    ## YEAR                    -0.0190   0.0115  -1.6445  580  0.1006   -0.0416   0.0037      
    ## SYNDROMTYPEInpatient     2.2067   0.0440  50.1141  580  <.0001    2.1202   2.2932  *** 
    ## SYNDROMTYPEOutpatient    1.3433   0.0294  45.6228  580  <.0001    1.2855   1.4012  *** 
    ## AGEAge below 5           1.8484   0.0249  74.2674  580  <.0001    1.7995   1.8973  *** 
    ## AGEMixed ages            1.1923   0.0373  31.9861  580  <.0001    1.1191   1.2656  *** 
    ## REFERENCEOther          -0.4495   0.1416  -3.1737  580  0.0016   -0.7277  -0.1713   ** 
    ## COVERAGE                -0.0042   0.0016  -2.6719  580  0.0078   -0.0073  -0.0011   ** 
    ## STRAINGroup_A            0.2707   0.1590   1.7026  580  0.0892   -0.0416   0.5830    . 
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Full    13 4372.1688 4428.8882 4372.8119 -2173.0844               15037.3242 
    ## Reduced 12 4375.1117 4427.4887 4375.6609 -2175.5558 4.9428 0.0262 15207.3252
...
``` r
setwd(params$Dir)
image <- paste0("02-fit-rota-strain-rota_files/figure-gfm/r_lineartimetrend.png")
cat("![](",image,")")
```

![](02-fit-rota-strain-rota_files/figure-gfm/r_lineartimetrend.png)
...
``` r
setwd(params$Dir)
image <- paste0("02-fit-rota-strain-rota_files/figure-gfm/r_nonlineartimetrend.png")
cat("![](",image,")")
```

![](02-fit-rota-strain-rota_files/figure-gfm/r_nonlineartimetrend.png)
...
setwd(params$Dir)
for (i in 1:length){
  image <- paste0("02-fit-rota-strain-rota_files/figure-gfm/r_summary-",i,".png")
  cat("![](",image,")")
}
```

![](02-fit-rota-strain-rota_files/figure-gfm/r_summary-1.png)![](02-fit-rota-strain-rota_files/figure-gfm/r_summary-2.png)![](02-fit-rota-strain-rota_files/figure-gfm/r_summary-3.png)![](02-fit-rota-strain-rota_files/figure-gfm/r_summary-4.png)![](02-fit-rota-strain-rota_files/figure-gfm/r_summary-5.png)![](02-fit-rota-strain-rota_files/figure-gfm/r_summary-6.png)![](02-fit-rota-strain-rota_files/figure-gfm/r_summary-7.png)![](02-fit-rota-strain-rota_files/figure-gfm/r_summary-8.png)![](02-fit-rota-strain-rota_files/figure-gfm/r_summary-9.png)![](02-fit-rota-strain-rota_files/figure-gfm/r_summary-10.png)![](02-fit-rota-strain-rota_files/figure-gfm/r_summary-11.png)![](02-fit-rota-strain-rota_files/figure-gfm/r_summary-12.png)![](02-fit-rota-strain-rota_files/figure-gfm/r_summary-13.png)![](02-fit-rota-strain-rota_files/figure-gfm/r_summary-14.png)![](02-fit-rota-strain-rota_files/figure-gfm/r_summary-15.png)

``` r
P <- plot(conditional_effects(fit_brms_reg_s), points = TRUE, ask=FALSE)
```

![](02-fit-rota-strain-rota_files/figure-gfm/r_conditional_effects-1.png)<!-- -->![](02-fit-rota-strain-rota_files/figure-gfm/r_conditional_effects-2.png)<!-- -->![](02-fit-rota-strain-rota_files/figure-gfm/r_conditional_effects-3.png)<!-- -->![](02-fit-rota-strain-rota_files/figure-gfm/r_conditional_effects-4.png)<!-- -->![](02-fit-rota-strain-rota_files/figure-gfm/r_conditional_effects-5.png)<!-- -->![](02-fit-rota-strain-rota_files/figure-gfm/r_conditional_effects-6.png)<!-- -->
...
# setwd(params$Dir)
for (i in 1:length){
  image <- paste0("02-fit-rota-strain-rota_files/figure-gfm/r_conditional_effects-",i,".png")
  cat("![](",image,")")
}
```
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpOgtm2C/file37e84ff11a53 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpOgtm2C/file37e84ff11a53". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
