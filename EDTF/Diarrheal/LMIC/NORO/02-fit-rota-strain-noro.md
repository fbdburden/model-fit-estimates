Diarrheal Norovirus • Models fit
================
fbbu6966
2025-09-28
...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpMtu9zo/file40b867aef7a -V' had status 1
...
es$STRAIN <- relevel(es$STRAIN, "GI_GII")
...
```
    ...
    ## 
    ## Multivariate Meta-Analysis Model (k = 503; method: REML)
    ## 
    ##     logLik    Deviance         AIC         BIC        AICc   
    ## -1082.9243   2165.8487   2189.8487   2240.3034   2190.4960   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed                factor 
    ## sigma^2.1  0.0000  0.0003      6     no                  REG2 
    ## sigma^2.2  0.0000  0.0005     11     no             REG2/SUB2 
    ## sigma^2.3  0.0414  0.2036     41     no     REG2/SUB2/COUNTRY 
    ## sigma^2.4  0.5150  0.7176    134     no  REG2/SUB2/COUNTRY/ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 495) = 10388.2840, p-val < .0001
    ## 
    ## Test of Moderators (coefficients 2:8):
    ## F(df1 = 7, df2 = 495) = 35.4574, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                        estimate      se      tval   df    pval    ci.lb    ci.ub      
    ## intrcpt                 -2.1724  0.0887  -24.5043  495  <.0001  -2.3465  -1.9982  *** 
    ## SYNDROMTYPEInpatient     0.5194  0.0416   12.4869  495  <.0001   0.4376   0.6011  *** 
    ## SYNDROMTYPEOutpatient    0.2048  0.0232    8.8190  495  <.0001   0.1591   0.2504  *** 
    ## AGEAge below 5          -0.1246  0.0198   -6.2820  495  <.0001  -0.1636  -0.0856  *** 
    ## AGEMixed ages           -0.1977  0.0423   -4.6764  495  <.0001  -0.2808  -0.1147  *** 
    ## REFERENCEOther          -0.5742  0.3480   -1.6498  495  0.0996  -1.2579   0.1096    . 
    ## COVERAGE                 0.0038  0.0016    2.4286  495  0.0155   0.0007   0.0069    * 
    ## STRAINGII               -0.5212  0.3609   -1.4442  495  0.1493  -1.2303   0.1879      
    ## 
    ## ---
...
```
    ...
    ## 
    ##     logLik    Deviance         AIC         BIC        AICc   
    ## -1081.3288   2162.6576   2188.6576   2243.2906   2189.4159   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed                factor 
    ## sigma^2.1  0.0000  0.0004      6     no                  REG2 
    ## sigma^2.2  0.0000  0.0004     11     no             REG2/SUB2 
    ## sigma^2.3  0.0276  0.1663     41     no     REG2/SUB2/COUNTRY 
    ## sigma^2.4  0.5238  0.7238    134     no  REG2/SUB2/COUNTRY/ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 494) = 9700.7829, p-val < .0001
    ## 
    ## Test of Moderators (coefficients 2:9):
    ## F(df1 = 8, df2 = 494) = 31.1376, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                        estimate       se     tval   df    pval     ci.lb    ci.ub      
    ## intrcpt                -32.7292  29.5231  -1.1086  494  0.2681  -90.7356  25.2771      
    ## YEAR                     0.0152   0.0147   1.0352  494  0.3011   -0.0137   0.0441      
    ## SYNDROMTYPEInpatient     0.5196   0.0416  12.4921  494  <.0001    0.4378   0.6013  *** 
    ## SYNDROMTYPEOutpatient    0.2048   0.0232   8.8218  494  <.0001    0.1592   0.2504  *** 
    ## AGEAge below 5          -0.1247   0.0198  -6.2864  494  <.0001   -0.1637  -0.0857  *** 
    ## AGEMixed ages           -0.1986   0.0423  -4.6969  494  <.0001   -0.2817  -0.1155  *** 
    ## REFERENCEOther          -0.5809   0.3478  -1.6700  494  0.0955   -1.2643   0.1025    . 
    ## COVERAGE                 0.0027   0.0018   1.4891  494  0.1371   -0.0009   0.0063      
    ## STRAINGII               -0.5035   0.3604  -1.3969  494  0.1631   -1.2116   0.2047      
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Full    13 2188.6576 2243.2906 2189.4159 -1081.3288                9700.7829 
    ## Reduced 12 2189.8487 2240.3034 2190.4960 -1082.9243 3.1911 0.0740 10388.2840
...
``` r
setwd(params$Dir)
image <- paste0("02-fit-rota-strain-noro_files/figure-gfm/r_lineartimetrend.png")
cat("![](",image,")")
```

![](02-fit-rota-strain-noro_files/figure-gfm/r_lineartimetrend.png)
...
``` r
setwd(params$Dir)
image <- paste0("02-fit-rota-strain-noro_files/figure-gfm/r_nonlineartimetrend.png")
cat("![](",image,")")
```

![](02-fit-rota-strain-noro_files/figure-gfm/r_nonlineartimetrend.png)
...
setwd(params$Dir)
for (i in 1:length){
  image <- paste0("02-fit-rota-strain-noro_files/figure-gfm/r_summary-",i,".png")
  cat("![](",image,")")
}
```

![](02-fit-rota-strain-noro_files/figure-gfm/r_summary-1.png)![](02-fit-rota-strain-noro_files/figure-gfm/r_summary-2.png)![](02-fit-rota-strain-noro_files/figure-gfm/r_summary-3.png)![](02-fit-rota-strain-noro_files/figure-gfm/r_summary-4.png)![](02-fit-rota-strain-noro_files/figure-gfm/r_summary-5.png)![](02-fit-rota-strain-noro_files/figure-gfm/r_summary-6.png)![](02-fit-rota-strain-noro_files/figure-gfm/r_summary-7.png)![](02-fit-rota-strain-noro_files/figure-gfm/r_summary-8.png)![](02-fit-rota-strain-noro_files/figure-gfm/r_summary-9.png)![](02-fit-rota-strain-noro_files/figure-gfm/r_summary-10.png)![](02-fit-rota-strain-noro_files/figure-gfm/r_summary-11.png)![](02-fit-rota-strain-noro_files/figure-gfm/r_summary-12.png)![](02-fit-rota-strain-noro_files/figure-gfm/r_summary-13.png)![](02-fit-rota-strain-noro_files/figure-gfm/r_summary-14.png)![](02-fit-rota-strain-noro_files/figure-gfm/r_summary-15.png)

``` r
P <- plot(conditional_effects(fit_brms_reg_s), points = TRUE, ask=FALSE)
```

![](02-fit-rota-strain-noro_files/figure-gfm/r_conditional_effects-1.png)<!-- -->![](02-fit-rota-strain-noro_files/figure-gfm/r_conditional_effects-2.png)<!-- -->![](02-fit-rota-strain-noro_files/figure-gfm/r_conditional_effects-3.png)<!-- -->![](02-fit-rota-strain-noro_files/figure-gfm/r_conditional_effects-4.png)<!-- -->![](02-fit-rota-strain-noro_files/figure-gfm/r_conditional_effects-5.png)<!-- -->![](02-fit-rota-strain-noro_files/figure-gfm/r_conditional_effects-6.png)<!-- -->
...
# setwd(params$Dir)
for (i in 1:length){
  image <- paste0("02-fit-rota-strain-noro_files/figure-gfm/r_conditional_effects-",i,".png")
  cat("![](",image,")")
}
```
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpMtu9zo/file40b875b944ab -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/RtmpMtu9zo/file40b875b944ab". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
