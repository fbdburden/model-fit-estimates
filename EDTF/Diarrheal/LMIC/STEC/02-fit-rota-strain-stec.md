...
```
    ...
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp0kgjaE/file38f0483347eb -V' had status 1
...
es$STRAIN <- relevel(es$STRAIN, "eae_stx")
...
```
    ...
    ## -392.2410   784.4820   806.4820   844.3009   807.6931   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed                factor 
    ## sigma^2.1  0.5535  0.7440      6     no                  REG2 
    ## sigma^2.2  0.0000  0.0009     10     no             REG2/SUB2 
    ## sigma^2.3  0.1439  0.3793     36     no     REG2/SUB2/COUNTRY 
    ## sigma^2.4  1.2173  1.1033     79     no  REG2/SUB2/COUNTRY/ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 230) = 2060.3257, p-val < .0001
    ## 
    ## Test of Moderators (coefficients 2:7):
    ## F(df1 = 6, df2 = 230) = 8.6831, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                       estimate      se      tval   df    pval    ci.lb    ci.ub      
    ## intrcpt                -4.0259  0.3815  -10.5539  230  <.0001  -4.7775  -3.2743  *** 
    ## SYNDROMTYPEInpatient   -0.1849  0.1495   -1.2371  230  0.2173  -0.4795   0.1096      
    ## AGEAge below 5          0.4727  0.0809    5.8393  230  <.0001   0.3132   0.6322  *** 
    ## AGEMixed ages           0.3081  0.1237    2.4905  230  0.0135   0.0644   0.5519    * 
    ## REFERENCEOther          0.7547  0.9276    0.8137  230  0.4167  -1.0729   2.5824      
    ## COVERAGE                0.0012  0.0046    0.2551  230  0.7989  -0.0079   0.0103      
    ## STRAINother            -2.0280  0.5627   -3.6044  230  0.0004  -3.1366  -0.9194  *** 
    ## 
    ## ---
...
```
    ...
    ## 
    ##    logLik   Deviance        AIC        BIC       AICc   
    ## -390.2806   780.5612   804.5612   845.7659   806.0057   
    ## 
    ## Variance Components:
    ## 
    ##             estim    sqrt  nlvls  fixed                factor 
    ## sigma^2.1  0.4552  0.6747      6     no                  REG2 
    ## sigma^2.2  0.0000  0.0009     10     no             REG2/SUB2 
    ## sigma^2.3  0.2079  0.4560     36     no     REG2/SUB2/COUNTRY 
    ## sigma^2.4  1.2087  1.0994     79     no  REG2/SUB2/COUNTRY/ID 
    ## 
    ## Test for Residual Heterogeneity:
    ## QE(df = 229) = 2020.1565, p-val < .0001
    ## 
    ## Test of Moderators (coefficients 2:8):
    ## F(df1 = 7, df2 = 229) = 7.5371, p-val < .0001
    ## 
    ## Model Results:
    ## 
    ##                       estimate       se     tval   df    pval      ci.lb    ci.ub      
    ## intrcpt               -55.7242  69.8721  -0.7975  229  0.4260  -193.3986  81.9503      
    ## YEAR                    0.0257   0.0347   0.7399  229  0.4601    -0.0428   0.0942      
    ## SYNDROMTYPEInpatient   -0.1854   0.1496  -1.2387  229  0.2167    -0.4802   0.1095      
    ## AGEAge below 5          0.4729   0.0810   5.8407  229  <.0001     0.3134   0.6325  *** 
    ## AGEMixed ages           0.3048   0.1238   2.4620  229  0.0146     0.0609   0.5488    * 
    ## REFERENCEOther          0.8099   0.9394   0.8622  229  0.3895    -1.0411   2.6610      
    ## COVERAGE               -0.0002   0.0051  -0.0484  229  0.9615    -0.0103   0.0098      
    ## STRAINother            -1.9392   0.5848  -3.3160  229  0.0011    -3.0915  -0.7869   ** 
    ## 
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    ## Full    12 804.5612 845.7659 806.0057 -390.2806               2020.1565 
    ## Reduced 11 806.4820 844.3009 807.6931 -392.2410 3.9208 0.0477 2060.3257
...
``` r
setwd(params$Dir)
image <- paste0("02-fit-rota-strain-stec_files/figure-gfm/r_lineartimetrend.png")
cat("![](",image,")")
```

![](02-fit-rota-strain-stec_files/figure-gfm/r_lineartimetrend.png)
...
``` r
setwd(params$Dir)
image <- paste0("02-fit-rota-strain-stec_files/figure-gfm/r_nonlineartimetrend.png")
cat("![](",image,")")
```

![](02-fit-rota-strain-stec_files/figure-gfm/r_nonlineartimetrend.png)
...
setwd(params$Dir)
for (i in 1:length){
  image <- paste0("02-fit-rota-strain-stec_files/figure-gfm/r_summary-",i,".png")
  cat("![](",image,")")
}
```

![](02-fit-rota-strain-stec_files/figure-gfm/r_summary-1.png)![](02-fit-rota-strain-stec_files/figure-gfm/r_summary-2.png)![](02-fit-rota-strain-stec_files/figure-gfm/r_summary-3.png)![](02-fit-rota-strain-stec_files/figure-gfm/r_summary-4.png)![](02-fit-rota-strain-stec_files/figure-gfm/r_summary-5.png)![](02-fit-rota-strain-stec_files/figure-gfm/r_summary-6.png)![](02-fit-rota-strain-stec_files/figure-gfm/r_summary-7.png)![](02-fit-rota-strain-stec_files/figure-gfm/r_summary-8.png)![](02-fit-rota-strain-stec_files/figure-gfm/r_summary-9.png)![](02-fit-rota-strain-stec_files/figure-gfm/r_summary-10.png)![](02-fit-rota-strain-stec_files/figure-gfm/r_summary-11.png)![](02-fit-rota-strain-stec_files/figure-gfm/r_summary-12.png)![](02-fit-rota-strain-stec_files/figure-gfm/r_summary-13.png)![](02-fit-rota-strain-stec_files/figure-gfm/r_summary-14.png)

``` r
P <- plot(conditional_effects(fit_brms_reg_s), points = TRUE, ask=FALSE)
```

![](02-fit-rota-strain-stec_files/figure-gfm/r_conditional_effects-1.png)<!-- -->![](02-fit-rota-strain-stec_files/figure-gfm/r_conditional_effects-2.png)<!-- -->![](02-fit-rota-strain-stec_files/figure-gfm/r_conditional_effects-3.png)<!-- -->![](02-fit-rota-strain-stec_files/figure-gfm/r_conditional_effects-4.png)<!-- -->![](02-fit-rota-strain-stec_files/figure-gfm/r_conditional_effects-5.png)<!-- -->![](02-fit-rota-strain-stec_files/figure-gfm/r_conditional_effects-6.png)<!-- -->
...
# setwd(params$Dir)
for (i in 1:length){
  image <- paste0("02-fit-rota-strain-stec_files/figure-gfm/r_conditional_effects-",i,".png")
  cat("![](",image,")")
}
```
...
```
    ...
    ##   r_4_1 = (sd_4[1] * (z_4[1]));
    ##   r_5_1 = (sd_5[1] * (z_5[1]));
    ##   lprior += student_t_lpdf(Intercept | 3, -3.5, 2.5);
...
```
    ...
    ## Warning in system2("quarto", "-V", stdout = TRUE, env = paste0("TMPDIR=", : running command '"quarto"
    ## TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp0kgjaE/file38f028b25518 -V' had status 1
    ...
    ##  quarto   ERROR: Unknown command "TMPDIR=C:/Users/fbbu6966/AppData/Local/Temp/Rtmp0kgjaE/file38f028b25518". Did you mean command "update"? @ C:\\Users\\fbbu6966\\AppData\\Local\\Programs\\RStudio\\RESOUR~1\\app\\bin\\quarto\\bin\\quarto.exe
    ## 
    ## ─ Packages ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
