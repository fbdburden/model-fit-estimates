...
#   dalymod:::get_samples(
#     n_samples,
#     "../../ESTIMATES_HIC/06-epec/sim_all_inc_glb_ct_20250508.rds",
#     transformation = "log",
#     denominator = 1e5)
# summarize(hic_inc)
# 
...
##bd::render_today("edtf-diarrhea-epec-daly.R")