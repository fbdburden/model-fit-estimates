### FERG2/EDTF/DIARRHEA/CRYPTOSPORIDIUM/DALY
...
hic_inc <-
  dalymod:::get_samples(
    n_samples,
    "../../ESTIMATES_HIC/02-crypto/sim_all_inc_reg_ct_20250518.rds",
    transformation = "log",
    denominator = 1e5)
summarize(hic_inc)
...
hic_mrt <-
  dalymod:::get_samples(
    n_samples,
    "../../ESTIMATES_HIC/02-crypto/sim_all_mrt_glb_ct_20251208.rds",
    transformation = "log",
    denominator = 1e5)
summarize(hic_mrt)
...
hic_age <-
  list(`2000` = c("<5" = 0.188, "5-9" = 0.141, "10-19" = 0.119, "20-64" = 0.531, "65+" = 0.021),
       `2010` = c("<5" = 0.126, "5-9" = 0.066, "10-19" = 0.121, "20-64" = 0.566, "65+" = 0.121),
       `2021` = c("<5" = 0.118, "5-9" = 0.054, "10-19" = 0.121, "20-64" = 0.586, "65+" = 0.122))
hic_age <-
...
##bd::render_today("edtf-diarrhea-crypto-daly.R")