### FERG2/EDTF/DIARRHEA/CYCLOSPORA/DALY
...
hic_inc <-
  dalymod:::get_samples(
    n_samples,
    "../../ESTIMATES_HIC/03-cyclo/sim_all_inc_glb_ct_20250508.rds",
    transformation = "log",
    denominator = 1e5)
summarize(hic_inc)
...
hic_age <-
  list(`2000` = c("<5" = 0.000, "5-9" = 0.000, "10-19" = 0.045, "20-64" = 0.864, "65+" = 0.091),
       `2010` = c("<5" = 0.000, "5-9" = 0.000, "10-19" = 0.036, "20-64" = 0.857, "65+" = 0.107),
       `2021` = c("<5" = 0.003, "5-9" = 0.005, "10-19" = 0.027, "20-64" = 0.781, "65+" = 0.184))
hic_age <-
...
##bd::render_today("edtf-diarrhea-cyclo-daly.R")