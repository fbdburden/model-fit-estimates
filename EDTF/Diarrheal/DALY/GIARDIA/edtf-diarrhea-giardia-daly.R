### FERG2/EDTF/DIARRHEA/GIARDIA/DALY
...
hic_inc <-
  dalymod:::get_samples(
    n_samples,
    "../../ESTIMATES_HIC/08-giardia/sim_all_inc_reg_ct_20250509.rds",
    transformation = "log",
    denominator = 1e5)
summarize(hic_inc)
...
hic_age <-
  list(`2000` = c("<5" = 0.213, "5-14" = 0.153, "15-24" = 0.073, "25-39" = 0.244, "40-64" = 0.261, "65+" = 0.056),
       `2010` = c("<5" = 0.190, "5-14" = 0.175, "15-24" = 0.105, "25-39" = 0.175, "40-64" = 0.277, "65+" = 0.077),
       `2021` = c("<5" = 0.080, "5-14" = 0.086, "15-24" = 0.102, "25-39" = 0.221, "40-64" = 0.337, "65+" = 0.174))
hic_age <-
...
rle_ad_hic <-
  rbind(cbind(AGE = "5-14", get_weighted_rle("5-14")),
        ...
        cbind(AGE = "25-39", get_weighted_rle("25-39")),
        cbind(AGE = "40-64", get_weighted_rle("40-64")),
...
##bd::render_today("edtf-diarrhea-giardia-daly.R")