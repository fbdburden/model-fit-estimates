### FERG2/EDTF/DIARRHEA/SHIGELLA/DALY
...
hic_inc <-
  dalymod:::get_samples(
    n_samples,
    "../../ESTIMATES_HIC/12-shig/sim_all_inc_reg_ct_20251011.rds",
    transformation = "log",
    denominator = 1e5)
summarize(hic_inc)
...
hic_mrt <-
  dalymod:::get_samples(
    n_samples,
    "../../ESTIMATES_HIC/12-shig/sim_all_mrt_reg_ct_20251208.rds",
    transformation = "log",
    denominator = 1e5)
summarize(hic_mrt)
...
hic_age <-
  list(`2000` = c("<5" = 0.263, "5-9" = 0.183, "10-19" = 0.065, "20-64" = 0.474, "65+" = 0.015),
       `2010` = c("<5" = 0.294, "5-9" = 0.206, "10-19" = 0.078, "20-64" = 0.393, "65+" = 0.029),
       `2021` = c("<5" = 0.070, "5-9" = 0.037, "10-19" = 0.050, "20-64" = 0.750, "65+" = 0.093))
hic_age <-
...
##bd::render_today("edtf-diarrhea-shig-daly.R")